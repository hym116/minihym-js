                    ...
                    if (moveY > 0) {
                        ...
                        if (movePrev || touchStart) {
                            ...
                            if (next) {
                                if (next.classList.contains("page")) {
                                    ...
                                    next.style.webkitTransform = "translate" + that._direction + "(-100%)";
                                    $(next).trigger("active");
                                    current.style.webkitTransformOrigin = "bottom center";
                                } else {
                                    current.style.webkitTransform = "translate" + that._direction + "(0px)";
                                    next = null;
                                }
                            }
                        } else {
                            current.style.webkitTransform = "translate" + that._direction + "(" + moveY + "px)";
                            next.style.webkitTransform = "translate" + that._direction + "(-" + (window.innerHeight - moveY) + "px)";
                        }
                    } else if (0 > moveY) {
                        ...
                        if (!movePrev || touchStart) {
                            ...
                            if (next && next.classList.contains("page")) {
                                ...
                                next.classList.add("z-move");
                                next.style.webkitTransition = "none";
                                next.style.webkitTransform = "translate" + that._direction + "(" + window.innerHeight + "px)";
                                $(next).trigger("active");
            ...
            if (moving) {
                ...
                if (next) {
                    ...
                    if (Math.abs(moveY) > Math.abs(moveX) && Math.abs(moveY) > 100) {
                        if (movePrev) {
                            current.style.webkitTransform = "translate" + that._direction + "(-" + window.innerHeight + "px)";
                            next.style.webkitTransform = "translate" + that._direction + "(0px)";
                        } else {
                            current.style.webkitTransform = "translate" + that._direction + "(" + window.innerHeight + "px)";
                            next.style.webkitTransform = "translate" + that._direction + "(0px)";
                        }
        ...
        window._app_showPage = function(index,notrans) {
            ...
            if (this._isFirstShowPage && !(next && next.length)) {
                ...
                if (index > currentIndex) {
                    ...
                    next[0].style.webkitTransform = "translate" + that._direction + "(" + window.innerHeight + "px)";
                    current[0].style.webkitTransform = "translate" + that._direction + "(0px)";

                    setTimeout(function() {
                        next[0].style.webkitTransform = "translate" + that._direction + "(0px)";
                        current[0].style.webkitTransform = "translate" + that._direction + "(-" + window.innerHeight + "px)";
                    }, 100);
