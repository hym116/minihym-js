(function(Slider) {
    Slider.prototype.initAnimation = function() {
        ...
        this.swiper.addCallback("SlideReset", function(swiper, direction) {
         ...
         // console.log($(swiper.slides[1]));
        this.swiper.addCallback("SlideChangeEnd", function(swiper, direction) {
            console.log($(swiper.activeSlide()));

            // $(swiper.activeSlide()).on("touchmove mousewheel mousemove",function(e){
            //     e.preventDefault();
            //     e.stopPropagation();
            // });
            $(swiper.slides[3]).on("touchmove mousewheel mousemove",function(e){
                e.preventDefault();
                e.stopPropagation();
            });
