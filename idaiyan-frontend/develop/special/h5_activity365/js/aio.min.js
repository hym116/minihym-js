! function(e, t) {
    ...
    function r(e, n, i, r) {
        if (ct.acceptData(e)) {
            ...
            if (c && u[c] && (r || u[c].data) || i !== t || "string" != typeof n)
                return c || (c = l ? e[s] = tt.pop() || ct.guid++ : s), u[c] || (u[c] = l ? {} : {
                    toJSON: ct.noop
    ...
    function x(e, n) {
        ...
        if (!a)
            for (a = [], i = e.childNodes || e; null != (r = i[o]); o++)
                !n || ct.nodeName(r, n) ? a.push(r) : ct.merge(a, x(r, n));
    ...
    function S(e, t) {
        for (var n, i, r, o = [], a = 0, s = e.length; s > a; a++)
            i = e[a], i.style && (o[a] = ct._data(i, "olddisplay"), n = i.style.display, t ? (o[a] || "none" !== n || (i.style.display = ""), "" === i.style.display && C(i) && (o[a] = ct._data(i, "olddisplay", N(i.nodeName)))) : o[a] || (r = C(i), (n && "none" !== n || !r) && ct._data(i, "olddisplay", r ? n : ct.css(i, "display"))));
        for (a = 0; s > a; a++)
    ...
    function E(e, t, n, i, r) {
        for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2)
            "margin" === n && (a += ct.css(e, n + Sn[o], !0, r)), i ? ("content" === n && (a -= ct.css(e, "padding" + Sn[o], !0, r)), "margin" !== n && (a -= ct.css(e, "border" + Sn[o] + "Width", !0, r))) : (a += ct.css(e, "padding" + Sn[o], !0, r), "padding" !== n && (a += ct.css(e, "border" + Sn[o] + "Width", !0, r)));
        return a
    }
    ...
    function L(e, t, n) {
        ...
        if (0 >= r || null == r) {
            if (r = pn(e, t, o), (0 > r || null == r) && (r = e.style[t]), wn.test(r))
                return r;
    ...
    function N(e) {
        var t = J,
            n = bn[e];
        return n || (n = M(e, t), "none" !== n && n || (cn = (cn || ct("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement), t = (cn[0].contentWindow || cn[0].contentDocument).document, t.write("<!doctype html><html><body>"), t.close(), n = M(e, t), cn.detach()), bn[e] = n), n
    }
    ...
    function z(e, t, n) {
        var i, r, o = 0,
            ...
            l = function() {
                if (r)
                    return !1;
                for (var t = Zn || I(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, o = 1 - i, a = 0, l = u.tweens.length; l > a; a++)
                    u.tweens[a].run(o);
        ...
        for (B(c, u.opts.specialEasing); a > o; o++)
            if (i = ri[o].call(u, e, c, u.opts))
                return i;
        return ct.map(c, O, u), ct.isFunction(u.opts.start) && u.opts.start.call(e, u), ct.fx.timer(ct.extend(l, {
            elem: e,
            anim: u,
            queue: u.opts.queue
    ...
    function R(e, t, n) {
        ...
        if (!ct.isEmptyObject(c)) {
            ...
            for (i in c)
                a = O(p ? f[i] : 0, i, u), i in f || (f[i] = a.start, p && (a.end = a.start, a.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    ...
    function q(e, t) {
        ...
        for (t = t ? 1 : 0; 4 > r; r += 2 - t)
            n = Sn[r], i["margin" + n] = i["padding" + n] = e;
    ...
    var V, X, Y = typeof t,
        ...
        Ct = function(e) {
            (J.addEventListener || "load" === e.type || "complete" === J.readyState) && (St(), ct.ready())
        },
        St = function() {
            J.addEventListener ? (J.removeEventListener("DOMContentLoaded", Ct, !1), e.removeEventListener("load", Ct, !1)) : (J.detachEvent("onreadystatechange", Ct), e.detachEvent("onload", Ct))
        };
    ct.fn = ct.prototype = {
            jquery: nt,
            constructor: ct,
            init: function(e, n, i) {
                ...
                if (!e)
                    return this;
                if ("string" == typeof e) {
                    if (r = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : ht.exec(e), !r || !r[1] && n)
            ...
            map: function(e, t, i) {
                ...
                if (s)
                    for (; a > o; o++)
                        r = t(e[o], o, i), null != r && (l[l.length] = r);
                else
                    for (o in e)
                        r = t(e[o], o, i), null != r && (l[l.length] = r);
                return it.apply([], l)
            ...
            if (!V)
                if (V = ct.Deferred(), "complete" === J.readyState)
                    setTimeout(ct.ready);
                else if (J.addEventListener)
                J.addEventListener("DOMContentLoaded", Ct, !1), e.addEventListener("load", Ct, !1);
            else {
                J.attachEvent("onreadystatechange", Ct), e.attachEvent("onload", Ct);
                var n = !1;
                try {
        ...
        function(e, t) {
            function n(e, t, n, i) {
                ...
                if ((t ? t.ownerDocument || t : z) !== P && D(t), t = t || P, n = n || [], !e || "string" != typeof e)
                    return n;
                ...
                if (W && !i) {
                    if (r = wt.exec(e))
                        if (a = r[1]) {
                            ...
                            if ((a = r[3]) && C.getElementsByClassName && t.getElementsByClassName)
                                return et.apply(n, t.getElementsByClassName(a)), n
                        }
                    if (C.qsa && (!j || !j.test(e))) {
                        if (d = c = O, h = t, g = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                            for (u = p(e), (c = t.getAttribute("id")) ? d = c.replace(Tt, "\\$&") : t.setAttribute("id", d), d = "[id='" + d + "'] ", l = u.length; l--;)
                                u[l] = d + f(u[l]);
            ...
            function p(e, t) {
                ...
                for (s = e, l = [], u = k.preFilter; s;) {
                    ...
                    for (a in k.filter)
                        !(r = vt[a].exec(s)) || u[a] && !(r = u[a](r)) || (i = r.shift(), o.push({
                            value: i,
                            type: a,
                            matches: r
                        }), s = s.slice(i.length));
            ...
            function h(e, t, n) {
                ...
                return t.first ? function(t, n, o) {
                    ...
                    if (a) {
                        ...
                        for (; t = t[i];)
                            if (1 === t.nodeType || r)
                                if (u = t[O] || (t[O] = {}), (l = u[i]) && l[0] === c) {
                                    if ((s = l[1]) === !0 || s === S)
                                        return s === !0
                                } else if (l = u[i] = [c], l[1] = e(t, n, a) || S, l[1] === !0)
                        return !0
                }
            }
            ...
            function v(e, t, n, i, o, a) {
                return i && !i[O] && (i = v(i)), o && !o[O] && (o = v(o, a)), r(function(r, a, s, l) {
                    var u, c, d, p = [],
                        ...
                        y = n ? o || (r ? e : h || i) ? [] : a : v;
                    if (n && n(v, y, s, l), i)
                        for (u = m(y, f), i(u, [], s, l), c = u.length; c--;)
                            (d = u[c]) && (y[f[c]] = !(v[f[c]] = d));
                    if (r) {
                        if (o || e) {
                            if (o) {
                            ...
                            for (c = y.length; c--;)
                                (d = y[c]) && (u = o ? nt.call(r, d) : p[c]) > -1 && (r[u] = !(a[u] = d))
                        }
                    } else
                ...
                var i = 0,
                    ...
                    s = function(r, s, l, u, c) {
                        var d, p, f, h = [],
                            ...
                            w = null != c,
                            x = M,
                            b = r || a && k.find.TAG("*", c && s.parentNode || s),
                            T = B += null == x ? 1 : Math.random() || .1;
                        for (w && (M = s !== P && s, S = i); null != (d = b[v]); v++) {
                            if (a && d) {
                                for (p = 0; f = e[p++];)
                                    if (f(d, s, l)) {
                                        u.push(d);
            ...
            function b(e, t, n, i) {
                var r, o, a, s, l, u = p(e);
                if (!i && 1 === u.length) {
                    if (o = u[0] = u[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && C.getById && 9 === t.nodeType && W && k.relative[o[1].type]) {
                        if (t = (k.find.ID(a.matches[0].replace(Ct, St), t) || [])[0], !t)
                            return n;
                        e = e.slice(o.shift().value.length)
                    }
                    for (r = vt.needsContext.test(e) ? 0 : o.length; r-- && (a = o[r], !k.relative[s = a.type]);)
                        if ((l = k.find[s]) && (i = l(a.matches[0].replace(Ct, St), ft.test(o[0].type) && t.parentNode || t))) {
                            if (o.splice(r, 1), e = i.length && f(o), !e)
                                return et.apply(n, i), n;
                            break
                        }
                }
                return N(e, u)(i, t, !W, n, ft.test(e)), n
            }
            var T, C, S, k, E, L, N, M, A, D, P, H, W, j, _, F, I, O = "sizzle" + -new Date,
                z = e.document,
                B = 0,
                R = 0,
                $ = i(),
            ...
            L = n.isXML = function(e) {
                ...
                var t = e ? e.ownerDocument || e : z,
                    n = t.defaultView;
                return t !== P && 9 === t.nodeType && t.documentElement ? (P = t, H = t.documentElement, W = !L(t), n && n.attachEvent && n !== n.top && n.attachEvent("onbeforeunload", function() {
                    D()
                    ...
                    return H.appendChild(e).id = O, !t.getElementsByName || !t.getElementsByName(O).length
                }), C.getById ? (k.find.ID = function(e, t) {
                    if (typeof t.getElementById !== Y && W) {
                    ...
                    return typeof t.getElementsByClassName !== Y && W ? t.getElementsByClassName(e) : void 0
                }, _ = [], j = [], (C.qsa = yt.test(t.querySelectorAll)) && (o(function(e) {
                ...
                })), (C.matchesSelector = yt.test(F = H.webkitMatchesSelector || H.mozMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)) && o(function(e) {
                    C.disconnectedMatch = F.call(e, "div"), F.call(e, "[s!='']:x"), _.push("!=", lt)
                }), j = j.length && new RegExp(j.join("|")), _ = _.length && new RegExp(_.join("|")), I = yt.test(H.contains) || H.compareDocumentPosition ? function(e, t) {
                    ...
                    if (t)
                        for (; t = t.parentNode;)
                            if (t === e)
                                return !0;
                    return !1
                }, X = H.compareDocumentPosition ? function(e, n) {
                    if (e === n)
                        return V = !0, 0;
                    var i = n.compareDocumentPosition && e.compareDocumentPosition && e.compareDocumentPosition(n);
                    return i ? 1 & i || !C.sortDetached && n.compareDocumentPosition(e) === i ? e === t || I(z, e) ? -1 : n === t || I(z, n) ? 1 : A ? nt.call(A, e) - nt.call(A, n) : 0 : 4 & i ? -1 : 1 : e.compareDocumentPosition ? -1 : 1
                } : function(e, n) {
                    var i, r = 0,
                        o = e.parentNode,
                        a = n.parentNode,
                ...
                if ((e.ownerDocument || e) !== P && D(e), t = t.replace(ht, "='$1']"), !(!C.matchesSelector || !W || _ && _.test(t) || j && j.test(t)))
                    try {
                        var i = F.call(e, t);
                ...
                var i = k.attrHandle[n.toLowerCase()],
                    r = i && J.call(k.attrHandle, n.toLowerCase()) ? i(e, n, !W) : t;
                return r === t ? C.attributes || !W ? e.getAttribute(n) : (r = e.getAttributeNode(n)) && r.specified ? r.value : null : r
            }, n.error = function(e) {
                ...
                var t, n = [],
                    i = 0,
                    r = 0;
                if (V = !C.detectDuplicates, A = !C.sortStable && e.slice(0), e.sort(X), V) {
                    for (; t = e[r++];)
                        t === e[r] && (i = n.push(r));
                    for (; i--;)
                        e.splice(n[i], 1)
                ...
                filter: {
                        ...
                        return 1 === i && 0 === r ? function(e) {
                            ...
                            if (m) {
                                ...
                                if (h = [a ? m.firstChild : m.lastChild], a && y) {
                                    for (c = m[O] || (m[O] = {}), u = c[e] || [], f = u[0] === B && u[1], p = u[0] === B && u[2], d = f && m.childNodes[f]; d = ++f && d && d[g] || (p = f = 0) || h.pop();)
                                        if (1 === d.nodeType && ++p && d === t) {
                                            c[e] = [B, f, p];
                                            break
                                        }
                                } else if (y && (u = (t[O] || (t[O] = {}))[e]) && u[0] === B)
                                    p = u[1];
                                else
                                    for (;
                                        (d = ++f && d && d[g] || (p = f = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++p || (y && ((d[O] || (d[O] = {}))[e] = [B, p]), d !== t));)
                                ;
                    ...
                    PSEUDO: function(e, t) {
                        ...
                        return o[O] ? o(t) : o.length > 1 ? (i = [e, e, "", t], k.setFilters.hasOwnProperty(e.toLowerCase()) ? r(function(e, n) {
                            for (var i, r = o(e, t), a = r.length; a--;)
                                i = nt.call(e, r[a]), e[i] = !(n[i] = r[a])
                        }) : function(e) {
                            return o(e, 0, i)
                        }) : o
                    }
            ...
            d.prototype = k.filters = k.pseudos, k.setFilters = new d, N = n.compile = function(e, t) {
                ...
                return o
            }, C.sortStable = O.split("").sort(X).join("") === O, C.detectDuplicates = V, D(), C.sortDetached = o(function(e) {
            ...
            p = {
                ...
                remove: function() {
                    return u && ct.each(arguments, function(e, t) {
                        for (var i;
                            (i = ct.inArray(t, u, i)) > -1;)
                            u.splice(i, 1), n && (a >= i && a--, s >= i && s--)
                    }), this
                },
                has: function(e) {
        ...
        when: function(e) {
            ...
            if (a > 1)
                for (t = new Array(a), n = new Array(a), i = new Array(a); a > r; r++)
                    o[r] && ct.isFunction(o[r].promise) ? o[r].promise().done(u(r, i, o)).fail(l.reject).progress(u(r, n, t)) : --s;
    ...
    ct.extend({
        ...
        data: function(e, n) {
            ...
            if (e === t) {
                if (this.length && (o = ct.data(l), 1 === l.nodeType && !ct._data(l, "parsedAttrs"))) {
                    for (i = l.attributes; s < i.length; s++)
                        r = i[s].name, 0 === r.indexOf("data-") && (r = ct.camelCase(r.slice(5)), a(l, r, o[r]));
        ...
        promise: function(e, n) {
            ...
            for ("string" != typeof e && (n = e, e = t), e = e || "fx"; s--;)
                i = ct._data(a[s], e + "queueHooks"), i && i.empty && (r++, i.empty.add(l));
    ...
    ct.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(ct.isFunction(e) ? function(n) {
                ...
                if ("string" === n)
                    for (var t, i = 0, r = ct(this), o = e.match(pt) || []; t = o[i++];)
        ...
        val: function(e) {
            var n, i, r, o = this[0]; {
                ...
                if (o)
                    return i = ct.valHooks[o.type] || ct.valHooks[o.nodeName.toLowerCase()], i && "get" in i && (n = i.get(o, "value")) !== t ? n : (n = o.value, "string" == typeof n ? n.replace(Dt, "") : null == n ? "" : n)
            }
        }
    }), ct.extend({
        valHooks: {
        ...
        attr: function(e, n, i) {
            ...
            if (e && 3 !== a && 8 !== a && 2 !== a)
                return typeof e.getAttribute === Y ? ct.prop(e, n, i) : (1 === a && ct.isXMLDoc(e) || (n = n.toLowerCase(), r = ct.attrHooks[n] || (ct.expr.match.bool.test(n) ? Mt : Nt)), i === t ? r && "get" in r && null !== (o = r.get(e, n)) ? o : (o = ct.find.attr(e, n), null == o ? t : o) : null !== i ? r && "set" in r && (o = r.set(e, i, n)) !== t ? o : (e.setAttribute(n, i + ""), i) : void ct.removeAttr(e, n))
        },
        removeAttr: function(e, t) {
            ...
            if (o && 1 === e.nodeType)
                for (; n = o[r++];)
                    i = ct.propFix[n] || n, ct.expr.match.bool.test(n) ? _t && jt || !Wt.test(n) ? e[i] = !1 : e[ct.camelCase("default-" + n)] = e[i] = !1 : ct.attr(e, n, ""), e.removeAttribute(jt ? n : i)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        prop: function(e, n, i) {
            ...
            if (e && 3 !== s && 8 !== s && 2 !== s)
                return a = 1 !== s || !ct.isXMLDoc(e), a && (n = ct.propFix[n] || n, o = ct.propHooks[n]), i !== t ? o && "set" in o && (r = o.set(e, i, n)) !== t ? r : e[n] = i : o && "get" in o && null !== (r = o.get(e, n)) ? r : e[n]
        },
        propHooks: {
            tabIndex: {
                get: function(e) {
        ...
        set: function(e, t, n) {
            return t === !1 ? ct.removeAttr(e, n) : _t && jt || !Wt.test(n) ? e.setAttribute(!jt && ct.propFix[n] || n, n) : e[ct.camelCase("default-" + n)] = e[n] = !0, n
        }
    }, ct.each(ct.expr.match.bool.source.match(/\w+/g), function(e, n) {
        var i = ct.expr.attrHandle[n] || ct.find.attr;
        ct.expr.attrHandle[n] = _t && jt || !Wt.test(n) ? function(e, n, r) {
    ...
    ct.event = {
        ...
        add: function(e, n, i, r, o) {
            ...
            if (v) {
                for (i.handler && (u = i, i = u.handler, o = u.selector), i.guid || (i.guid = ct.guid++), (s = v.events) || (s = v.events = {}), (d = v.handle) || (d = v.handle = function(e) {
                    ...
                    }, d.elem = e), n = (n || "").match(pt) || [""], l = n.length; l--;)
                    a = Bt.exec(n[l]) || [], h = m = a[1], g = (a[2] || "").split(".").sort(), h && (c = ct.event.special[h] || {}, h = (o ? c.delegateType : c.bindType) || h, c = ct.event.special[h] || {}, p = ct.extend({
                        type: h,
                        origType: m,
                        data: r,
                        handler: i,
        ...
        remove: function(e, t, n, i, r) {
            ...
            if (m && (c = m.events)) {
                for (t = (t || "").match(pt) || [""], u = t.length; u--;)
                    if (s = Bt.exec(t[u]) || [], f = g = s[1], h = (s[2] || "").split(".").sort(), f) {
                        for (d = ct.event.special[f] || {}, f = (i ? d.delegateType : d.bindType) || f, p = c[f] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = o = p.length; o--;)
                            a = p[o], !r && g !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || i && i !== a.selector && ("**" !== i || !a.selector) || (p.splice(o, 1), a.selector && p.delegateCount--, d.remove && d.remove.call(e, a));
                        l && !p.length && (d.teardown && d.teardown.call(e, h, m.handle) !== !1 || ct.removeEvent(e, f, m.handle), delete c[f])
                    } else
                        for (f in c)
                            ct.event.remove(e, f + t[u], n, i, !0);
        ...
        trigger: function(n, i, r, o) {
            ...
            if (l = d = r = r || J, 3 !== r.nodeType && 8 !== r.nodeType && !zt.test(h + ct.event.triggered) && (h.indexOf(".") >= 0 && (g = h.split("."), h = g.shift(), g.sort()), s = h.indexOf(":") < 0 && "on" + h, n = n[ct.expando] ? n : new ct.Event(h, "object" == typeof n && n), n.isTrigger = o ? 2 : 3, n.namespace = g.join("."), n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = t, n.target || (n.target = r), i = null == i ? [n] : ct.makeArray(i, [n]), c = ct.event.special[h] || {}, o || !c.trigger || c.trigger.apply(r, i) !== !1)) {
                if (!o && !c.noBubble && !ct.isWindow(r)) {
                    for (u = c.delegateType || h, zt.test(u + h) || (l = l.parentNode); l; l = l.parentNode)
                        f.push(l), d = l;
                    d === (r.ownerDocument || J) && f.push(d.defaultView || d.parentWindow || e)
                }
                for (p = 0;
                    (l = f[p++]) && !n.isPropagationStopped();)
                    n.type = p > 1 ? u : c.bindType || h, a = (ct._data(l, "events") || {})[n.type] && ct._data(l, "handle"), a && a.apply(l, i), a = s && l[s], a && ct.acceptData(l) && a.apply && a.apply(l, i) === !1 && n.preventDefault();
            ...
            if (l[0] = e, e.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
                for (s = ct.event.handlers.call(this, e, u), n = 0;
                    ...
                    for (e.currentTarget = o.elem, a = 0;
                        ...
                        (!e.namespace_re || e.namespace_re.test(r.namespace)) && (e.handleObj = r, e.data = r.data, i = ((ct.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l), i !== t && (e.result = i) === !1 && (e.preventDefault(), e.stopPropagation()));
            ...
            if (l && u.nodeType && (!e.button || "click" !== e.type))
                for (; u != this; u = u.parentNode || this)
                    if (1 === u.nodeType && (u.disabled !== !0 || "click" !== e.type)) {
                        for (o = [], a = 0; l > a; a++)
                            r = n[a], i = r.selector + " ", o[i] === t && (o[i] = r.needsContext ? ct(i, this).index(u) >= 0 : ct.find(i, this, null, [u]).length), o[i] && o.push(r);
                        o.length && s.push({
                            elem: u,
                            handlers: o
                        })
        ...
        fix: function(e) {
            ...
            var t, n, i, r = e.type,
                o = e,
                a = this.fixHooks[r];
            for (a || (this.fixHooks[r] = a = Ot.test(r) ? this.mouseHooks : It.test(r) ? this.keyHooks : {}), i = a.props ? this.props.concat(a.props) : this.props, e = new ct.Event(o), t = i.length; t--;)
                n = i[t], e[n] = o[n];
    ...
    ct.fn.extend({
        ...
        is: function(e) {
            return !!p(this, "string" == typeof e && qt.test(e) ? ct(e) : e || [], !1).length
        },
        closest: function(e, t) {
            for (var n, i = 0, r = this.length, o = [], a = qt.test(e) || "string" != typeof e ? ct(e, t || this.context) : 0; r > i; i++)
        ...
        ct.fn[e] = function(n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = ct.filter(i, r)), this.length > 1 && (Gt[e] || (r = ct.unique(r)), $t.test(e) && (r = r.reverse())), this.pushStack(r)
        }
    }), ct.extend({
    ...
    sn.optgroup = sn.option, sn.tbody = sn.tfoot = sn.colgroup = sn.caption = sn.thead, sn.th = sn.td, ct.fn.extend({
        ...
        remove: function(e, t) {
            for (var n, i = e ? ct.filter(e, this) : this, r = 0; null != (n = i[r]); r++)
                t || 1 !== n.nodeType || ct.cleanData(x(n)), n.parentNode && (t && ct.contains(n.ownerDocument, n) && v(x(n, "script")), n.parentNode.removeChild(n));
            return this
        },
        empty: function() {
        ...
        html: function(e) {
            return ct.access(this, function(e) {
                ...
                if (!("string" != typeof e || en.test(e) || !ct.support.htmlSerialize && Yt.test(e) || !ct.support.leadingWhitespace && Ut.test(e) || sn[(Kt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    ...
                    try {
                        for (; r > i; i++)
                            n = this[i] || {}, 1 === n.nodeType && (ct.cleanData(x(n, !1)), n.innerHTML = e);
                        n = 0
                    } catch (o) {}
                }
        ...
        domManip: function(e, t, n) {
            ...
            if (c && (l = ct.buildFragment(e, this[0].ownerDocument, !1, !n && this), i = l.firstChild, 1 === l.childNodes.length && (l = i), i)) {
                for (a = ct.map(x(l, "script"), g), o = a.length; c > u; u++)
                    r = l, u !== p && (r = ct.clone(r, !0, !0), o && ct.merge(a, x(r, "script"))), t.call(this[u], r, u);
                if (o)
                    for (s = a[a.length - 1].ownerDocument, ct.map(a, m), u = 0; o > u; u++)
                        r = a[u], rn.test(r.type || "") && !ct._data(r, "globalEval") && ct.contains(s, r) && (r.src ? ct._evalUrl(r.src) : ct.globalEval((r.text || r.textContent || r.innerHTML || "").replace(an, "")));
                l = i = null
            }
            return this
        }
        ...
        clone: function(e, t, n) {
            ...
            if (ct.support.html5Clone || ct.isXMLDoc(e) || !Yt.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (un.innerHTML = e.outerHTML, un.removeChild(o = un.firstChild)), !(ct.support.noCloneEvent && ct.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ct.isXMLDoc(e)))
                for (i = x(o), s = x(e), a = 0; null != (r = s[a]); ++a)
                    i[a] && w(r, i[a]);
            if (t)
                if (n)
                    for (s = s || x(e), i = i || x(o), a = 0; null != (r = s[a]); a++)
                        y(r, i[a]);
                else
                    y(e, o);
        ...
        buildFragment: function(e, t, n, i) {
            for (var r, o, a, s, l, u, c, d = e.length, p = f(t), h = [], g = 0; d > g; g++)
                ...
                for (s = s || p.appendChild(t.createElement("div")), l = (Kt.exec(o) || ["", ""])[1].toLowerCase(), c = sn[l] || sn._default, s.innerHTML = c[1] + o.replace(Jt, "<$1></$2>") + c[2], r = c[0]; r--;)
                    s = s.lastChild;
                if (!ct.support.leadingWhitespace && Ut.test(o) && h.push(t.createTextNode(Ut.exec(o)[0])), !ct.support.tbody)
                    for (o = "table" !== l || Qt.test(o) ? "<table>" !== c[1] || Qt.test(o) ? 0 : s : s.firstChild, r = o && o.childNodes.length; r--;)
            ...
            for (s && p.removeChild(s), ct.support.appendChecked || ct.grep(x(h, "input"), b), g = 0; o = h[g++];)
                if ((!i || -1 === ct.inArray(o, i)) && (a = ct.contains(o.ownerDocument, o), s = x(p.appendChild(o), "script"), a && v(s), n))
                    for (r = 0; o = s[r++];)
    ...
    ct.fn.extend({
        ...
        style: function(e, n, i, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, a, s, l = ct.camelCase(n),
                    u = e.style;
                if (n = ct.cssProps[l] || (ct.cssProps[l] = T(u, l)), s = ct.cssHooks[n] || ct.cssHooks[l], i === t)
                    return s && "get" in s && (o = s.get(e, !1, r)) !== t ? o : u[n];
                if (a = typeof i, "string" === a && (o = xn.exec(i)) && (i = (o[1] + 1) * o[2] + parseFloat(ct.css(e, n)), a = "number"), !(null == i || "number" === a && isNaN(i) || ("number" !== a || ct.cssNumber[l] || (i += "px"), ct.support.clearCloneStyle || "" !== i || 0 !== n.indexOf("background") || (u[n] = "inherit"), s && "set" in s && (i = s.set(e, i, r)) === t)))
                    try {
                        u[n] = i
                    } catch (c) {}
            }
        ...
        css: function(e, n, i, r) {
            var o, a, s, l = ct.camelCase(n);
            return n = ct.cssProps[l] || (ct.cssProps[l] = T(e.style, l)), s = ct.cssHooks[n] || ct.cssHooks[l], s && "get" in s && (a = s.get(e, !0, i)), a === t && (a = pn(e, n, r)), "normal" === a && n in Cn && (a = Cn[n]), "" === i || i ? (o = parseFloat(a), i === !0 || ct.isNumeric(o) ? o || 0 : a) : a
        }
    ...
    Dn = Bn.exec(Pn.toLowerCase()) || [], ct.fn.load = function(e, n, i) {
        ...
        ajax: function(e, n) {
            function i(e, n, i, r) {
                var o, d, y, w, b, C = n;
                2 !== x && (x = 2, l && clearTimeout(l), c = t, s = r || "", T.readyState = e > 0 ? 4 : 0, o = e >= 200 && 300 > e || 304 === e, i && (w = W(p, T, i)), w = j(p, w, T, o), o ? (p.ifModified && (b = T.getResponseHeader("Last-Modified"), b && (ct.lastModified[a] = b), b = T.getResponseHeader("etag"), b && (ct.etag[a] = b)), 204 === e || "HEAD" === p.type ? C = "nocontent" : 304 === e ? C = "notmodified" : (C = w.state, d = w.data, y = w.error, o = !y)) : (y = C, (e || !C) && (C = "error", 0 > e && (e = 0))), T.status = e, T.statusText = (n || C) + "", o ? g.resolveWith(f, [d, C, T]) : g.rejectWith(f, [T, C, y]), T.statusCode(v), v = t, u && h.trigger(o ? "ajaxSuccess" : "ajaxError", [T, p, o ? d : y]), m.fireWith(f, [T, C]), u && (h.trigger("ajaxComplete", [T, p]), --ct.active || ct.event.trigger("ajaxStop")))
            }
            ...
            if (g.promise(T).complete = m.add, T.success = T.done, T.error = T.fail, p.url = ((e || p.url || Pn) + "").replace(jn, "").replace(zn, Dn[1] + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = ct.trim(p.dataType || "*").toLowerCase().match(pt) || [""], null == p.crossDomain && (r = Bn.exec(p.url.toLowerCase()), p.crossDomain = !(!r || r[1] === Dn[1] && r[2] === Dn[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (Dn[3] || ("http:" === Dn[1] ? "80" : "443")))), p.data && p.processData && "string" != typeof p.data && (p.data = ct.param(p.data, p.traditional)), P($n, p, n, T), 2 === x)
                return T;
            u = p.global, u && 0 === ct.active++ && ct.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !On.test(p.type), a = p.url, p.hasContent || (p.data && (a = p.url += (Wn.test(a) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = _n.test(a) ? a.replace(_n, "$1_=" + Hn++) : a + (Wn.test(a) ? "&" : "?") + "_=" + Hn++)), p.ifModified && (ct.lastModified[a] && T.setRequestHeader("If-Modified-Since", ct.lastModified[a]), ct.etag[a] && T.setRequestHeader("If-None-Match", ct.etag[a])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && T.setRequestHeader("Content-Type", p.contentType), T.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Gn + "; q=0.01" : "") : p.accepts["*"]);
            for (o in p.headers)
    ...
    ct.ajaxSetup({
        ...
        return l || "jsonp" === n.dataTypes[0] ? (o = n.jsonpCallback = ct.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, l ? n[l] = n[l].replace(Yn, "$1" + o) : n.jsonp !== !1 && (n.url += (Wn.test(n.url) ? "&" : "?") + n.jsonp + "=" + o), n.converters["script json"] = function() {
    ...
    } : _, Jn = ct.ajaxSettings.xhr(), ct.support.cors = !!Jn && "withCredentials" in Jn, Jn = ct.support.ajax = !!Jn, Jn && ct.ajaxTransport(function(n) {
                    ...
                    l.send(n.hasContent && n.data || null), i = function(e, r) {
                        ...
                        try {
                            if (i && (r || 4 === l.readyState))
                                if (i = t, a && (l.onreadystatechange = ct.noop, Qn && delete Un[a]), r)
    ...
    ct.Animation = ct.extend(z, {
        ...
        finish: function(e) {
            return e !== !1 && (e = e || "fx"), this.each(function() {
                var t, n = ct._data(this),
                    ...
                    o = ct.timers,
                    a = i ? i.length : 0;
                for (n.finish = !0, ct.queue(this, e, []), r && r.stop && r.stop.call(this, !0), t = o.length; t--;)
        ...
        var n, i, r = {
            ...
            a = o && o.ownerDocument;
        if (a)
            return n = a.documentElement, ct.contains(n, o) ? (typeof o.getBoundingClientRect !== Y && (r = o.getBoundingClientRect()), i = G(a), {
...
var Swiper = function(e, t) {
    ...
    function r() {
        var e = D - W;
        return t.freeMode && (e = D - W), t.slidesPerView > N.slides.length && !t.centeredSlides && (e = 0), 0 > e && (e = 0), e
    }
    ...
    function o() {
        ...
        if (N.browser.ie10 || N.browser.ie11 ? (i(r, N.touchEvents.touchStart, g), i(document, N.touchEvents.touchMove, m), i(document, N.touchEvents.touchEnd, v)) : (N.support.touch && (i(r, "touchstart", g), i(r, "touchmove", m), i(r, "touchend", v)), t.simulateTouch && (i(r, "mousedown", g), i(document, "mousemove", m), i(document, "mouseup", v))), t.autoResize && i(window, "resize", N.resizeFix), a(), N._wheelEvent = !1, t.mousewheelControl) {
            if (void 0 !== document.onmousewheel && (N._wheelEvent = "mousewheel"), !N._wheelEvent)
                try {
        ...
        if (t.keyboardControl && i(document, "keydown", l), t.updateOnImagesReady) {
            ...
            for (var s = 0; s < N.imagesToLoad.length; s++)
                e(N.imagesToLoad[s].getAttribute("src"))
        }
    }
    ...
    function a() {
        ...
        if (t.releaseFormElements) {
            ...
            for (e = 0; e < o.length; e++)
                i(o[e], N.touchEvents.touchStart, h, !0)
        }
        if (t.onSlideClick)
            for (e = 0; e < N.slides.length; e++)
                i(N.slides[e], "click", c);
        if (t.onSlideTouch)
            for (e = 0; e < N.slides.length; e++)
                i(N.slides[e], N.touchEvents.touchStart, d)
    }
    ...
    function s() {
        ...
        if (t.releaseFormElements) {
            ...
            for (e = 0; e < r.length; e++)
                i(r[e], N.touchEvents.touchStart, h, !0)
        }
        if (t.preventLinks) {
    ...
    function l(e) {
        ...
        if (!(e.shiftKey || e.altKey || e.ctrlKey || e.metaKey)) {
            ...
            I ? ((37 === t || 39 === t) && (e.preventDefault ? e.preventDefault() : e.returnValue = !1), 39 === t && N.swipeNext(), 37 === t && N.swipePrev()) : ((38 === t || 40 === t) && (e.preventDefault ? e.preventDefault() : e.returnValue = !1), 40 === t && N.swipeNext(), 38 === t && N.swipePrev())
        }
    }
    ...
    function u(e) {
        ...
        if (t.freeMode) {
            ...
            if (o > 0 && (o = 0), o < -r() && (o = -r()), N.setWrapperTransition(0), N.setWrapperTranslate(o), N.updateActiveSlide(o), 0 === o || o === -r())
                return
        } else
            (new Date).getTime() - V > 60 && (0 > i ? N.swipeNext() : N.swipePrev()), V = (new Date).getTime();
    ...
    function p(e) {
        if (e.currentTarget)
            N.clickedSlide = e.currentTarget;
        else {
            var n = e.srcElement;
            do {
    ...
    function g(e) {
        if (t.preventLinks && (N.allowLinks = !0), N.isTouched || t.onlyExternal)
            return !1;
        ...
        if (t.noSwiping && n && y(n))
            return !1;
        if (Q = !1, N.isTouched = !0, K = "touchstart" === e.type, !K && "which" in e && 3 === e.which)
            return !1;
        if (!K || 1 === e.targetTouches.length) {
            ...
            N.touches.startX = N.touches.currentX = r, N.touches.startY = N.touches.currentY = o, N.touches.start = N.touches.current = I ? r : o, N.setWrapperTransition(0), N.positions.start = N.positions.current = N.getWrapperTranslate(), N.setWrapperTranslate(N.positions.start), N.times.start = (new Date).getTime(), H = void 0, t.moveStartThreshold > 0 && (Y = !1), t.onTouchStart && N.fireCallback(t.onTouchStart, N, e), N.callPlugins("onTouchStartEnd")
        }
    }
    ...
    function m(e) {
        if (N.isTouched && !t.onlyExternal && (!K || "mousemove" !== e.type)) {
            ...
            if ("undefined" == typeof H && I && (H = !!(H || Math.abs(i - N.touches.startY) > Math.abs(n - N.touches.startX))), "undefined" != typeof H || I || (H = !!(H || Math.abs(i - N.touches.startY) < Math.abs(n - N.touches.startX))), H)
                return void(N.isTouched = !1);
            if (I) {
                if (!t.swipeToNext && n < N.touches.startX || !t.swipeToPrev && n > N.touches.startX)
                    return
            } else if (!t.swipeToNext && i < N.touches.startY || !t.swipeToPrev && i > N.touches.startY)
                return;
            ...
            if (e.assignedToSwiper = !0, t.preventLinks && (N.allowLinks = !1), t.onSlideClick && (N.allowSlideClick = !1), t.autoplay && N.stopAutoplay(!0), !K || 1 === e.touches.length) {
                if (N.isMoved || (N.callPlugins("onTouchMoveStart"), t.loop && (N.fixLoop(), N.positions.start = N.getWrapperTranslate()), t.onTouchMoveStart && N.fireCallback(t.onTouchMoveStart, N)), N.isMoved = !0, e.preventDefault ? e.preventDefault() : e.returnValue = !1, N.touches.current = I ? n : i, N.positions.current = (N.touches.current - N.touches.start) * t.touchRatio + N.positions.start, N.positions.current > 0 && t.onResistanceBefore && N.fireCallback(t.onResistanceBefore, N, N.positions.current), N.positions.current < -r() && t.onResistanceAfter && N.fireCallback(t.onResistanceAfter, N, Math.abs(N.positions.current + r())), t.resistance && "100%" !== t.resistance) {
                    var o;
                    if (N.positions.current > 0 && (o = 1 - N.positions.current / W / 2, N.positions.current = .5 > o ? W / 2 : N.positions.current * o), N.positions.current < -r()) {
                ...
                if (t.resistance && "100%" === t.resistance && (N.positions.current > 0 && (!t.freeMode || t.freeModeFluid) && (N.positions.current = 0), N.positions.current < -r() && (!t.freeMode || t.freeModeFluid) && (N.positions.current = -r())), !t.followFinger)
                    return;
                if (t.moveStartThreshold)
                    if (Math.abs(N.touches.current - N.touches.start) > t.moveStartThreshold || Y) {
                        if (!Y)
                            return Y = !0, void(N.touches.start = N.touches.current);
                        N.setWrapperTranslate(N.positions.current)
                    } else
                        N.positions.current = N.positions.start;
                else
                    N.setWrapperTranslate(N.positions.current);
    ...
    function v(e) {
        if (H && N.swipeReset(), !t.onlyExternal && N.isTouched) {
            ...
            var a = r();
            if (!N.isMoved && t.freeMode)
                return N.isMoved = !1, t.onTouchEnd && N.fireCallback(t.onTouchEnd, N, e), void N.callPlugins("onTouchEnd");
            if (!N.isMoved || N.positions.current > 0 || N.positions.current < -a)
                return N.swipeReset(), t.onTouchEnd && N.fireCallback(t.onTouchEnd, N, e), void N.callPlugins("onTouchEnd");
            ...
            if ("auto" === t.slidesPerView) {
                for (var h, g = Math.abs(N.getWrapperTranslate()), m = 0, v = 0; v < N.slides.length; v++)
                    if (h = I ? N.slides[v].getWidth(!0, t.roundLengths) : N.slides[v].getHeight(!0, t.roundLengths), m += h, m > g) {
                        f = h;
                        break
                    }
                f > W && (f = W)
    ...
    function x(e, n, i) {
        ...
        var o = "to" === n && i.speed >= 0 ? i.speed : t.speed,
            a = +new Date;
        if (N.support.transitions || !t.DOMAnimation)
            N.setWrapperTranslate(e), N.setWrapperTransition(o);
        else {
    ...
    function T() {
        ...
        if (e)
            for (var t = 0; t < e.length; t++)
                N.h.removeEventListener(e[t], "click", S)
    }
    ...
    function C() {
        ...
        if (e)
            for (var t = 0; t < e.length; t++)
                N.h.addEventListener(e[t], "click", S)
    }

    function S(e) {
        for (var n, i = e.target || e.srcElement, r = N.paginationButtons, o = 0; o < r.length; o++)
            i === r[o] && (n = o);
    ...
    if (window.getComputedStyle || (window.getComputedStyle = function(e) {
        ...
        t = t || {};
        for (var _ in j)
            if (_ in t && "object" == typeof t[_])
                for (var F in j[_])
                    F in t[_] || (t[_][F] = j[_][F]);
            else
                _ in t || (t[_] = j[_]);
        N.params = t, t.scrollContainer && (t.freeMode = !0, t.freeModeFluid = !0), t.loop && (t.resistance = "100%");
        var I = "horizontal" === t.mode,
            O = ["mousedown", "mousemove", "mouseup"];
        N.browser.ie10 && (O = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), N.browser.ie11 && (O = ["pointerdown", "pointermove", "pointerup"]), N.touchEvents = {
            touchStart: N.support.touch || !t.simulateTouch ? "touchstart" : O[0],
            touchMove: N.support.touch || !t.simulateTouch ? "touchmove" : O[1],
            touchEnd: N.support.touch || !t.simulateTouch ? "touchend" : O[2]
        };
        for (var z = N.container.childNodes.length - 1; z >= 0; z--)
            if (N.container.childNodes[z].className)
                for (var B = N.container.childNodes[z].className.split(/\s+/), R = 0; R < B.length; R++)
                    B[R] === t.wrapperClass && (M = N.container.childNodes[z]);
        N.wrapper = M, N._extendSwiperSlide = function(e) {
            return e.append = function() {
                ...
                for (var t, n = N.slides.length - 1; n >= 0; n--)
                    e === N.slides[n] && (t = n);
                return t
            }, e.isActive = function() {
            ...
            for (var i = 0; i < N.wrapper.childNodes.length; i++)
                if (N.wrapper.childNodes[i].className)
                    for (var r = N.wrapper.childNodes[i].className, o = r.split(/\s+/), l = 0; l < o.length; l++)
                        o[l] === t.slideClass && N.slides.push(N.wrapper.childNodes[i]);
            for (i = N.slides.length - 1; i >= 0; i--)
                N._extendSwiperSlide(N.slides[i]);
            ...
            for (var e = N.slides.length - 1; e >= 0; e--)
                N.slides[e].remove()
            ...
            if ("[object Array]" === Object.prototype.toString.call(e))
                ...
                "[object String]" === Object.prototype.toString.call(e) ? t["on" + e] && N.fireCallback(t["on" + e], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]) : e(arguments[1], arguments[2], arguments[3], arguments[4], arguments[5])
        ...
        var $ = [];
        for (var q in N.plugins)
            if (t[q]) {
                var G = N.plugins[q](N, t[q]);
                G && $.push(G)
            }
        N.callPlugins = function(e, t) {
            ...
            for (var n = 0; n < $.length; n++)
                e in $[n] && $[n][e](t)
        }, !N.browser.ie10 && !N.browser.ie11 || t.onlyExternal || N.wrapper.classList.add("swiper-wp8-" + (I ? "horizontal" : "vertical")), t.freeMode && (N.container.className += " swiper-free-mode"), N.initialized = !1, N.init = function(e, n) {
            ...
            if (i !== N.width || r !== N.height || e) {
                ...
                if (e && N.calcSlides(n), "auto" === t.slidesPerView) {
                    var f = 0,
                        h = 0;
                    t.slidesOffset > 0 && (p.style.paddingLeft = "", p.style.paddingRight = "", p.style.paddingTop = "", p.style.paddingBottom = ""), p.style.width = "", p.style.height = "", t.offsetPxBefore > 0 && (I ? N.wrapperLeft = t.offsetPxBefore : N.wrapperTop = t.offsetPxBefore), t.offsetPxAfter > 0 && (I ? N.wrapperRight = t.offsetPxAfter : N.wrapperBottom = t.offsetPxAfter), t.centeredSlides && (I ? (N.wrapperLeft = (W - this.slides[0].getWidth(!0, t.roundLengths)) / 2, N.wrapperRight = (W - N.slides[N.slides.length - 1].getWidth(!0, t.roundLengths)) / 2) : (N.wrapperTop = (W - N.slides[0].getHeight(!0, t.roundLengths)) / 2, N.wrapperBottom = (W - N.slides[N.slides.length - 1].getHeight(!0, t.roundLengths)) / 2)), I ? (N.wrapperLeft >= 0 && (p.style.paddingLeft = N.wrapperLeft + "px"), N.wrapperRight >= 0 && (p.style.paddingRight = N.wrapperRight + "px")) : (N.wrapperTop >= 0 && (p.style.paddingTop = N.wrapperTop + "px"), N.wrapperBottom >= 0 && (p.style.paddingBottom = N.wrapperBottom + "px")), c = 0;
                    var g = 0;
                        ...
                        if (t.centeredSlides) {
                            ...
                            if (m > W) {
                                if (t.slidesPerViewFit)
                                    N.snapGrid.push(c + N.wrapperLeft), N.snapGrid.push(c + m - W + N.wrapperLeft);
                                else
                                    for (var x = 0; x <= Math.floor(m / (W + N.wrapperLeft)); x++)
                                        N.snapGrid.push(0 === x ? c + N.wrapperLeft : c + N.wrapperLeft + W * x);
                                N.slidesGrid.push(c + N.wrapperLeft)
                            } else
                                N.snapGrid.push(g), N.slidesGrid.push(g);
                            g += m / 2 + w / 2
                        } else {
                            if (m > W)
                                if (t.slidesPerViewFit)
                                    N.snapGrid.push(c), N.snapGrid.push(c + m - W);
                                else if (0 !== W)
                                for (var b = 0; b <= Math.floor(m / W); b++)
                                    N.snapGrid.push(c + W * b);
                            else
                                N.snapGrid.push(c);
                            else
                                N.snapGrid.push(c);
                    ...
                    t.calculateHeight && (N.height = s), I ? (D = f + N.wrapperRight + N.wrapperLeft, p.style.width = f + "px", p.style.height = N.height + "px") : (D = h + N.wrapperTop + N.wrapperBottom, p.style.width = N.width + "px", p.style.height = h + "px")
                } else if (t.scrollContainer)
                    p.style.width = "", p.style.height = "", l = N.slides[0].getWidth(!0, t.roundLengths), u = N.slides[0].getHeight(!0, t.roundLengths), D = I ? l : u, p.style.width = l + "px", p.style.height = u + "px", A = I ? l : u;
                else {
                    if (t.calculateHeight) {
                        for (s = 0, u = 0, I || (N.container.style.height = ""), p.style.height = "", d = 0; d < N.slides.length; d++)
                            N.slides[d].style.height = "", s = Math.max(N.slides[d].getHeight(!0), s), I || (u += N.slides[d].getHeight(!0));
                        a = s, N.height = a, I ? u = a : (W = a, N.container.style.height = W + "px")
                    } else
                        a = I ? N.height : N.height / t.slidesPerView, t.roundLengths && (a = Math.ceil(a)), u = I ? N.height : N.slides.length * a;
                    for (o = I ? N.width / t.slidesPerView : N.width, t.roundLengths && (o = Math.ceil(o)), l = I ? N.slides.length * o : N.width, A = I ? o : a, t.offsetSlidesBefore > 0 && (I ? N.wrapperLeft = A * t.offsetSlidesBefore : N.wrapperTop = A * t.offsetSlidesBefore), t.offsetSlidesAfter > 0 && (I ? N.wrapperRight = A * t.offsetSlidesAfter : N.wrapperBottom = A * t.offsetSlidesAfter), t.offsetPxBefore > 0 && (I ? N.wrapperLeft = t.offsetPxBefore : N.wrapperTop = t.offsetPxBefore), t.offsetPxAfter > 0 && (I ? N.wrapperRight = t.offsetPxAfter : N.wrapperBottom = t.offsetPxAfter), t.centeredSlides && (I ? (N.wrapperLeft = (W - A) / 2, N.wrapperRight = (W - A) / 2) : (N.wrapperTop = (W - A) / 2, N.wrapperBottom = (W - A) / 2)), I ? (N.wrapperLeft > 0 && (p.style.paddingLeft = N.wrapperLeft + "px"), N.wrapperRight > 0 && (p.style.paddingRight = N.wrapperRight + "px")) : (N.wrapperTop > 0 && (p.style.paddingTop = N.wrapperTop + "px"), N.wrapperBottom > 0 && (p.style.paddingBottom = N.wrapperBottom + "px")), D = I ? l + N.wrapperRight + N.wrapperLeft : u + N.wrapperTop + N.wrapperBottom, parseFloat(l) > 0 && (!t.cssWidthAndHeight || "height" === t.cssWidthAndHeight) && (p.style.width = l + "px"), parseFloat(u) > 0 && (!t.cssWidthAndHeight || "width" === t.cssWidthAndHeight) && (p.style.height = u + "px"), c = 0, N.snapGrid = [], N.slidesGrid = [], d = 0; d < N.slides.length; d++)
                        N.snapGrid.push(c), N.slidesGrid.push(c), c += A, parseFloat(o) > 0 && (!t.cssWidthAndHeight || "height" === t.cssWidthAndHeight) && (N.slides[d].style.width = o + "px"), parseFloat(a) > 0 && (!t.cssWidthAndHeight || "width" === t.cssWidthAndHeight) && (N.slides[d].style.height = a + "px")
                }
        ...
        N.swipeNext = function(e) {
            ...
            return i < -r() && (i = -r()), i === n ? !1 : (x(i, "next"), !0)
            ...
            return n > 0 && (n = 0), n === i ? !1 : (x(n, "prev"), !0)
            ...
            if ("auto" === t.slidesPerView) {
                ...
                e = 0 > n ? Math.round(n / i) * i : 0, n <= -r() && (e = -r());
            return t.scrollContainer && (e = 0 > n ? n : 0), e < -r() && (e = -r()), t.scrollContainer && W > A && (e = 0), e === n ? !1 : (x(e, "reset"), !0)
            ...
            if (!(e > N.slides.length - 1 || 0 > e)) {
                var a;
                return a = "auto" === t.slidesPerView ? -N.slidesGrid[e] : -e * A, a < -r() && (a = -r()), a === o ? !1 : (i = i === !1 ? !1 : !0, x(a, "to", {
                    index: e,
                    speed: n,
                    runCallbacks: i
                }), !0)
            ...
            if (N.initialized && 0 !== N.slides.length) {
                ...
                if ("auto" === t.slidesPerView) {
                    ...
                    N.activeIndex = Math[t.visibilityFullFit ? "ceil" : "round"](-e / A);
                if (N.activeIndex === N.slides.length && (N.activeIndex = N.slides.length - 1), N.activeIndex < 0 && (N.activeIndex = 0), N.slides[N.activeIndex]) {
                    if (N.calcVisibleSlides(e), N.support.classList) {
                        var o;
                        for (n = 0; n < N.slides.length; n++)
                            o = N.slides[n], o.classList.remove(t.slideActiveClass), N.visibleSlides.indexOf(o) >= 0 ? o.classList.add(t.slideVisibleClass) : o.classList.remove(t.slideVisibleClass);
                        ...
                        for (n = 0; n < N.slides.length; n++)
                            N.slides[n].className = N.slides[n].className.replace(a, "").replace(s, ""), N.visibleSlides.indexOf(N.slides[n]) >= 0 && (N.slides[n].className += " " + t.slideVisibleClass);
                    ...
                    if (t.loop) {
                        ...
                        N.activeLoopIndex = N.activeIndex;
            ...
            N.paginationButtons = n("." + t.paginationElementClass, N.paginationContainer), e || N.updatePagination(), N.callPlugins("onCreatePagination"), t.paginationClickable && C()
                ...
                if (i) {
                    ...
                    if (0 !== r.length) {
                        ...
                        if (t.paginationAsRange) {
                            ...
                            t.loop ? r[N.activeLoopIndex] && (r[N.activeLoopIndex].className += " " + t.paginationActiveClass + " " + t.paginationVisibleClass) : r[N.activeIndex].className += " " + t.paginationActiveClass + " " + t.paginationVisibleClass
                    }
                }
            }
            ...
            var n = [],
                ...
                r = 0,
                o = 0;
            I && N.wrapperLeft > 0 && (e += N.wrapperLeft), !I && N.wrapperTop > 0 && (e += N.wrapperTop);
            for (var a = 0; a < N.slides.length; a++) {
                i += r, r = "auto" === t.slidesPerView ? I ? N.h.getWidth(N.slides[a], !0, t.roundLengths) : N.h.getHeight(N.slides[a], !0, t.roundLengths) : A, o = i + r;
                var s = !1;
                t.visibilityFullFit ? (i >= -e && -e + W >= o && (s = !0), -e >= i && o >= -e + W && (s = !0)) : (o > -e && -e + W >= o && (s = !0), i >= -e && -e + W > i && (s = !0), -e > i && o > -e + W && (s = !0)), s && n.push(N.slides[a])
            }
        ...
        N.startAutoplay = function() {
            ...
            if (N.support.transitions) {
                ...
                et && clearInterval(et), et = void 0, N.callPlugins("onAutoplayStop"), t.onAutoplayStop && N.fireCallback(t.onAutoplayStop, N)
        }, N.loopCreated = !1, N.removeLoopedSlides = function() {
            if (N.loopCreated)
                for (var e = 0; e < N.slides.length; e++)
                    N.slides[e].getData("looped") === !0 && N.wrapper.removeChild(N.slides[e])
            ...
            if (0 !== N.slides.length) {
                ...
                for (e = 0; s > e; e++)
                    i += w(t.slideDuplicateClass, N.slides[e].outerHTML);
                for (e = o - s; o > e; e++)
                    n += w(t.slideDuplicateClass, N.slides[e].outerHTML);
                var c = n + r + M.innerHTML + r + i;
                for (M.innerHTML = c, N.loopCreated = !0, N.calcSlides(), e = 0; e < N.slides.length; e++)
                    (e < N.loopedSlides || e >= N.slides.length - N.loopedSlides) && N.slides[e].setData("looped", !0);
            ...
            for (var n = t.loader.slides, i = t.loader.loadAllSlides ? n.length : t.slidesPerView * (1 + t.loader.surroundGroups), r = 0; i > r; r++)
                e += "outer" === t.loader.slidesHTMLType ? n[r] : "<" + t.slideElement + ' class="' + t.slideClass + '" data-swiperindex="' + r + '">' + n[r] + "</" + t.slideElement + ">";
...
Swiper.prototype = {
            ...
            function n(s) {
                if (s.target === o && (e(r), r.params.queueEndCallbacks && (r._queueEndCallbacks = !1), !t))
                    for (i = 0; i < a.length; i++)
                        r.h.removeEventListener(o, a[i], n)
            }
            var i, r = this,
                o = r.wrapper,
    ...
    Swiper.prototype.plugins.progress = function(e) {
        function t() {
    ...
    Swiper.prototype.plugins.tdFlow = function(e, t) {
        function n() {
            ...
            for (var t = 0; t < r.length; t++)
                e.setTransition(r[t], 0);
            if (l) {
                o = e.h.getWidth(e.wrapper), a = o / r.length;
                for (var t = 0; t < r.length; t++)
                    r[t].swiperSlideOffset = r[t].offsetLeft
            } else {
                o = e.h.getHeight(e.wrapper), a = o / r.length;
                for (var t = 0; t < r.length; t++)
                    r[t].swiperSlideOffset = r[t].offsetTop
            }
        }
                ...
                var d = {
                    onFirstInit: function() {
                        if (r = e.slides, t.shadows) {
                            ...
                            for (var s = 0; s < r.length; s++)
                                r[s].appendChild(o.cloneNode()), r[s].appendChild(a.cloneNode())
                        }
                        n(), i({
                            x: e.getWrapperTranslate("x"),
                            y: e.getWrapperTranslate("y"),
                    ...
                    onSetWrapperTransition: function(n) {
                        for (var i = 0; i < e.slides.length; i++)
                            e.setTransition(e.slides[i], n.duration), l && t.shadows ? (e.setTransition(e.slides[i].querySelector(".swiper-slide-shadow-left"), n.duration), e.setTransition(e.slides[i].querySelector(".swiper-slide-shadow-right"), n.duration)) : t.shadows && (e.setTransition(e.slides[i].querySelector(".swiper-slide-shadow-top"), n.duration), e.setTransition(e.slides[i].querySelector(".swiper-slide-shadow-bottom"), n.duration))
                    }
                };
                return d
            }
...
! function() {
    ...
    function e(e, t, n, i, r, o) {
        this.conNode = e, this.background = null, this.backCtx = null, this.mask = null, this.maskCtx = null, this.lottery = null, this.lotteryType = "image", this.cover = t || "#000", this.coverType = n, this.pixlesData = null, this.width = i, this.height = r, this.lastPosition = null, this.drawPercentCallback = o, this.vail = !1
    }
    e.prototype = {
        init: function(e, t) {
            var n = this;
            e && (this.lottery = e, this.lottery.width = this.width, this.lottery.height = this.height, this.lotteryType = t || "image", this.vail = !0), this.vail && (this.background = this.background || this.createElement("canvas", {
                style: "position:fixed;left:50%;top:0;width:640px;margin-left:-320px;height:100%;background-color:transparent;"
            })), this.mask = this.mask || this.createElement("canvas", {
                style: "position:fixed;left:50%;top:0;width:640px;margin-left:-320px;height:100%;background-color:transparent;"
            }), this.mask.style.zIndex = 20, this.conNode.innerHTML.replace(/[\w\W]| /g, "") || (this.vail && this.conNode.appendChild(this.background), this.conNode.appendChild(this.mask), this.bindEvent()), this.vail && (this.backCtx = this.backCtx || this.background.getContext("2d")), this.maskCtx = this.maskCtx || this.mask.getContext("2d"), this.drawMask(), window.addEventListener("resize", function() {
        ...
        getTransparentPercent: function(e, t, n) {
            try {
                for (var i = e.getImageData(0, 0, t, n), r = i.data, o = [], a = 0, s = r.length; s > a; a += 4) {
                    var l = r[a + 3];
                    128 > l && o.push(a)
                }
            } catch (u) {
            ...
            return (o.length / (r.length / 4) * 100).toFixed(2)
        },
        ...
        drawPoint: function(e, t) {
            this.maskCtx.beginPath(), this.maskCtx.arc(e, t, 30, 0, 2 * Math.PI), this.maskCtx.fill(), this.maskCtx.beginPath(), this.maskCtx.lineWidth = 60, this.maskCtx.lineCap = this.maskCtx.lineJoin = "round", this.lastPosition && this.maskCtx.moveTo(this.lastPosition[0], this.lastPosition[1]), this.maskCtx.lineTo(e, t), this.maskCtx.stroke(), this.lastPosition = [e, t], this.mask.style.zIndex = 20 == this.mask.style.zIndex ? 21 : 20
        },
        bindEvent: function() {
            var e = this,
                ...
                r = !1;
            t ? (e.conNode.addEventListener("touchmove", function(e) {
                r && e.preventDefault(), e.cancelable ? e.preventDefault() : window.event.returnValue = !1
            }, !1), e.conNode.addEventListener("touchend", function() {
                r = !1;
                var t = e.getTransparentPercent(e.maskCtx, e.width, e.height);
                t >= 30 && "function" == typeof e.drawPercentCallback && e.drawPercentCallback()
            }, !1)) : e.conNode.addEventListener("mouseup", function(t) {
                t.preventDefault(), r = !1;
                var n = e.getTransparentPercent(e.maskCtx, e.width, e.height);
                n >= 30 && "function" == typeof e.drawPercentCallback && e.drawPercentCallback()
            }, !1), this.mask.addEventListener(n, function(n) {
                n.preventDefault(), r = !0;
                var i = t ? n.touches[0].pageX : n.pageX || n.x,
                    o = t ? n.touches[0].pageY : n.pageY || n.y;
                e.drawPoint(i, o)
        ...
        drawLottery: function() {
            if ("image" == this.lotteryType) {
                var e = new Image,
                    t = this;
                e.onload = function() {
                    this.width = t.width, this.height = t.height, t.resizeCanvas(t.background, t.width, t.height), t.backCtx.drawImage(this, 0, 0, t.width, t.height)
                }, e.src = this.lottery
            } else if ("text" == this.lotteryType) {
                var n = 30;
                this.width = this.width, this.height = this.height, this.resizeCanvas(this.background, this.width, this.height), this.backCtx.save(), this.backCtx.fillStyle = "#FFF", this.backCtx.fillRect(0, 0, this.width, this.height), this.backCtx.restore(), this.backCtx.save(), this.backCtx.font = "Bold " + n + "px Arial", this.backCtx.textAlign = "center", this.backCtx.fillStyle = "#F60", this.backCtx.fillText(this.lottery, this.width / 2, this.height / 2 + n / 2), this.backCtx.restore(), this.drawMask()
            }
        },
        drawMask: function() {
            if ("color" == this.coverType)
                ...
                e.onload = function() {
                    var e = 50;
                    t.resizeCanvas(t.mask, t.width, t.height), /android/i.test(navigator.userAgent.toLowerCase()), t.maskCtx.globalAlpha = .98, t.maskCtx.drawImage(this, 0, 0, this.width, this.height, 0, 0, t.width, t.height), text = "", gradient = t.maskCtx.createLinearGradient(0, 0, t.width, 0), gradient.addColorStop("0", "#fff"), gradient.addColorStop("1.0", "#000"), t.maskCtx.font = "Bold " + e + "px Arial", t.maskCtx.textAlign = "left", t.maskCtx.fillStyle = gradient, t.maskCtx.fillText(text, t.width / 2 - t.maskCtx.measureText(text).width / 2, t.height - 100), t.maskCtx.globalAlpha = 1, t.maskCtx.globalCompositeOperation = "destination-out", t.drawLottery()
                }, e.crossOrigin = "anonymous", e.src = this.cover
            }
        }
    }, window.Lottery = e
}(), ! function() {
    var e = {
        ...
        audioInit: function() {
            if (this.$_audioNode = $(".js-audio"), this.$_audioNode.length > 0) {
                ...
                this._audio = new Audio, this._audioPaused = !e.autoplay;
                for (var t in e)
                    e.hasOwnProperty(t) && t in this._audio && (this._audio[t] = e[t])
            }
        },
        audioControl: function() {
            if (this.$_audioNode.length > 0) {
                var e = this,
                    t = this.$_audioNode.find(".js-music-btn"),
                    n = $(this._audio),
                ...
                n.on("play", function() {
                    e._audioPaused = !1, t.removeClass("ui-music-off"), $.fn.coffee.start()
                }), n.on("pause", function() {
                    e._audioPaused = !0, t.addClass("ui-music-off"), $.fn.coffee.stop()
                }), this.$_audioNode.on(r, function() {
                    e.audioSwitch()
                }), n.trigger(this._audioPaused ? "pause" : "play")
            }
        },
        audioSwitch: function() {
            this._audioPaused ? this.audioPlay() : this.audioStop()
        },
        audioPlay: function() {
            this._audioPaused = !1, this._audio && this._audio.play()
        },
        audioStop: function() {
            this._audioPaused = !0, this._audio && this._audio.pause()
        },
        videoInit: function() {
            this._videoNode = $(".js-video"), this._videoNode.each(function() {
                var e = $(this),
                    ...
                    r = $(this).find(".img");
                for (var o in t)
                    t.hasOwnProperty(o) && o in i && (i[o] = t[o]);
        ...
        mediaControl: function() {
            ...
            this._audio && t.length > 0 && ($(this._audio).on("play", function() {
                ...
                e._audioPaused || e.audioSwitch()
            }), t.on("pause", function() {
                e._audioPaused && e.audioSwitch()
            }))
        },
        mediaInit: function() {
            this.audioInit(), this.videoInit(), this.audioControl(), this.mediaControl()
        }
    };
    window.Media = e
}(), ! function(e) {
    e.prototype.plugins.shadow = function(e) {
        ...
        function t() {
            for (var t = 0, i = e.slides.length; i > t; ++t)
                e.slides[t].style.zIndex = 20 + t;
        ...
        return {
            ...
            onTouchStartBegin: function() {
                for (var t = 0; t < e.slides.length; ++t)
                    e.setTransition(e.slides[t], 0)
            },
            onSetWrapperTransition: function(t) {
                for (var n = t.duration, i = 0; i < e.slides.length; ++i)
                    e.setTransition(e.slides[i], n)
            }
        }
    }
}(Swiper), ! function() {
    function e() {
        this.$loading = $(".js-loading"), this.$container = $(".js-power-scroll-container"), this.$power = this.$container.find(".js-power-scroll"), this.$coffee = this.$container.find(".js-coffee"), this.$arrow = this.$container.find(".js-arrow"), this.$lazy = this.$container.find(".js-lazy-scroll"), this.coffeeAnimation = '<img src="img/audio.png"/>', this.isMobile = /android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini/i.test(navigator.userAgent.toLowerCase()), this.eventName = this.isMobile ? "touchstart" : "click"
    }
    e.prototype.init = function() {
        this.coffee(), window.Media.mediaInit(), $(window).on("beforeunload", function() {
            window.Media.audioStop()
            ...
            r = function() {
                if (!i) {
                    ...
                    t = o > t ? 0 : t - o, setTimeout(function() {
                        e.$loading.fadeOut(), e.hasMask ? e.drawMask() : e.loaded()
                    }, t)
                }
            };
        this.lazyLoad(), $(window).on("load", r), setTimeout(r, t)
        ...
        var e = this.$maskNode.data("url"),
            t = "image",
            n = 640,
            i = $(window).height(),
            r = this.$maskNode[0];
        this.lottery = new window.Lottery(r, e, t, n, i, this.getDrawMaskCallback()).init(this.$maskNode.data("bg"))
    }, e.prototype.getDrawMaskCallback = function() {
        var e = this;
        return function() {
            e.loaded(), e.$maskNode.find("canvas").fadeOut()
        }
    }, e.prototype.loaded = function() {
        this.initSwiper(), this.initAnimation && this.initAnimation(), this.swiper.fireCallback("FirstInit", this.swiper), this.show(), this.showArrow(), this.resize(), this.hasMask ? $(document).one(this.eventName, function() {
            window.Media.audioPlay()
        }) : window.Media.audioSwitch(), this.addLoadingBG()
        ...
        e = r(), this.swiper = this.$power.swiper(e), "horizontal" === e.mode ? this.swiper.addCallback("SlideChangeStart", function() {
            ...
            //t.swiper.swipeNext()
        }), this.$arrow.html("horizontal" === e.mode ? '<img src="img/arrow-left.png" alt="滑动提示">' : '<a href="javascript:;"><img src="'+static_mpath+'/images/arrow-up.png" alt="滑动提示"><img src="'+static_mpath+'/images/arrow-up.png" alt="滑动提示"><img src="'+static_mpath+'/images/arrow-up.png" alt="滑动提示"></a>'), this.$arrow.addClass("horizontal" === e.mode ? "ui-left-arrow" : "ui-up-arrow ")
        ...
        var e = "-webkit-background-size: initial;-moz-background-size: initial;background-size: initial; visibility: visible;";
