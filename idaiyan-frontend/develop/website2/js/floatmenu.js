        ...
        '<ul>'+
            ...
            '<li class="hassubmenu"><a href="javascript:;">个人中心</a>'+
                '<ul>'+
                    ...
                    '<li class="hassubmenu"><a href="javascript:;">修改信息</a>'+
                        '<ul>'+
                            '<li><a href="uc_modify.html">修改基本信息</a></li>'+
                            '<li class="hassubmenu"><a href="javascript:;">修改邮箱</a>'+
                                '<ul>'+
                                    '<li><a href="uc_mod_email1.html">修改邮箱第一步</a></li>'+
                                    '<li><a href="uc_mod_email2.html">修改邮箱第二步</a></li>'+
                                    '<li><a href="uc_mod_email3.html">修改邮箱第三步</a></li>'+
                                '</ul>'+
                            '</li>'+
                            '<li><a href="uc_mod_avatar.html">修改头像</a></li>'+
                            '<li><a href="uc_mod_password.html">修改密码</a></li>'+
                        '</ul>'+
                    '</li>'+
                '</ul>'+
            '</li>'+
