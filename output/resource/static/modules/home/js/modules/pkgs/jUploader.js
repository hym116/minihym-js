define('js/modules/pkgs/jUploader', ['require', 'exports', 'module', "jquery"],function(require, exports, module) {
/*
...
(function ($) {
    window.jUploader = $.jUploader = function (options) {
        ...
        var otherInput = function (){
            var otherData = options.otherData;
            var input = "";
            if (otherData) {
                for (var theName in otherData) {
                    if (otherData.hasOwnProperty(theName)) {
                        input += '<input type="hidden" name="'+ theName +'" value="'+ otherData[theName] +'" />';
                    }
                }
            }
            return input;
        ...
        var upload = function () {
            ...
            $('#jUploaderForm' + options.id).append(otherInput());
        ...
        var complete = function () {
            ...
            try {
                ...
                response = (new Function("", "return " + json))();
            } catch (e) {
                response = {};
                //throw e;
            }
