 ...
 *
 */
define('js/modules/libs/echarts/util/ecEffect', ['require', 'js/modules/libs/echarts/util/ecData', 'js/modules/libs/zrender/shape/Circle', 'js/modules/libs/zrender/shape/Image', 'js/modules/libs/echarts/util/shape/Icon', 'js/modules/libs/echarts/util/shape/Symbol', 'js/modules/libs/zrender/tool/env'],function (require) {
    ...
    var canvasSupported = require('js/modules/libs/zrender/tool/env').canvasSupported;
