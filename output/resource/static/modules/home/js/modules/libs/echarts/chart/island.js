 ...
 *
 */
define('js/modules/libs/echarts/chart/island', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/echarts/chart/base', 'js/modules/libs/zrender/shape/Circle', 'js/modules/libs/echarts/config', 'js/modules/libs/echarts/util/ecData', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/event', 'js/modules/libs/zrender/tool/color', 'js/modules/libs/echarts/util/accMath', 'js/modules/libs/echarts/chart'],function (require) {
    ...
    // 图表注册
    require('js/modules/libs/echarts/chart').define('island', Island);
