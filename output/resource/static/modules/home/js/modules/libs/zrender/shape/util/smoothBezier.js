...
define('js/modules/libs/zrender/shape/util/smoothBezier', 
    ['require', 'js/modules/libs/zrender/tool/vector'],function ( require ) {
        var vector = require('js/modules/libs/zrender/tool/vector');
