 ...
 * shape类：标线
 */
define('js/modules/libs/echarts/util/shape/MarkLine', ['require', 'js/modules/libs/zrender/shape/Base', 'js/modules/libs/echarts/util/shape/Icon', 'js/modules/libs/zrender/shape/Line', 'js/modules/libs/zrender/shape/BrokenLine', 'js/modules/libs/zrender/tool/matrix', 'js/modules/libs/zrender/tool/area', 'js/modules/libs/zrender/shape/util/dashedLineTo', 'js/modules/libs/zrender/shape/util/smoothSpline', 'js/modules/libs/zrender/tool/util'],function (require) {
    var Base = require('js/modules/libs/zrender/shape/Base');
    ...
    var matrix = require('js/modules/libs/zrender/tool/matrix');
    var area = require('js/modules/libs/zrender/tool/area');
    var dashedLineTo = require('js/modules/libs/zrender/shape/util/dashedLineTo');
    var smoothSpline = require('js/modules/libs/zrender/shape/util/smoothSpline');
