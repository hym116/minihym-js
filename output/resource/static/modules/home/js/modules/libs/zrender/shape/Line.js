 ...
 */
define('js/modules/libs/zrender/shape/Line', 
    ['require', 'js/modules/libs/zrender/shape/Base', 'js/modules/libs/zrender/shape/util/dashedLineTo', 'js/modules/libs/zrender/tool/util'],function (require) {
        ...
        require('js/modules/libs/zrender/tool/util').inherits(Line, Base);
        return Line;
    }
);