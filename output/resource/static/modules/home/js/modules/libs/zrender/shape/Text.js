 ...
 */
define('js/modules/libs/zrender/shape/Text', 
    ['require', 'js/modules/libs/zrender/tool/area', 'js/modules/libs/zrender/shape/Base', 'js/modules/libs/zrender/tool/util'],function (require) {
        ...
        require('js/modules/libs/zrender/tool/util').inherits(Text, Base);
        return Text;
    }
);
