 ...
 */
define('js/modules/libs/zrender/shape/Isogon', 
    ['require', 'js/modules/libs/zrender/tool/math', 'js/modules/libs/zrender/shape/Base', 'js/modules/libs/zrender/tool/util'],function (require) {
        ...
        require('js/modules/libs/zrender/tool/util').inherits(Isogon, Base);
        return Isogon;
    }
);