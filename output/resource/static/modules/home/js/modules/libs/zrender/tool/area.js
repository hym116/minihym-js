 ...
 */
define('js/modules/libs/zrender/tool/area', 
    ['require', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/shape/Path'],function(require) {
        ...
        function _isInsidePath(area, x, y) {
            if (!area.pointList) {
                require('js/modules/libs/zrender/shape/Path').prototype.buildPath(_ctx, area);
            }
            var pointList = area.pointList;
