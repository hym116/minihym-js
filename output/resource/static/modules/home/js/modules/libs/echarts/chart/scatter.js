 ...
 *
 */
define('js/modules/libs/echarts/chart/scatter', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/echarts/chart/base', 'js/modules/libs/echarts/util/shape/Symbol', 'js/modules/libs/echarts/component/axis', 'js/modules/libs/echarts/component/grid', 'js/modules/libs/echarts/component/dataZoom', 'js/modules/libs/echarts/component/dataRange', 'js/modules/libs/echarts/config', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/color', 'js/modules/libs/echarts/chart'],function (require) {
    ...
    // 图表注册
    require('js/modules/libs/echarts/chart').define('scatter', Scatter);
