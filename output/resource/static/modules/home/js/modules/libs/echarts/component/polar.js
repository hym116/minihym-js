 ...
 *
 */
define('js/modules/libs/echarts/component/polar', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/zrender/shape/Text', 'js/modules/libs/zrender/shape/Line', 'js/modules/libs/zrender/shape/Polygon', 'js/modules/libs/zrender/shape/Circle', 'js/modules/libs/zrender/shape/Ring', 'js/modules/libs/echarts/config', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/echarts/util/coordinates', 'js/modules/libs/echarts/component'],function (require) {
    ...
    var Circle = require('js/modules/libs/zrender/shape/Circle');
    var Ring = require('js/modules/libs/zrender/shape/Ring');

    var ecConfig = require('js/modules/libs/echarts/config');
    var zrUtil = require('js/modules/libs/zrender/tool/util');
    var ecCoordinates = require('js/modules/libs/echarts/util/coordinates');
    ...
    require('js/modules/libs/echarts/component').define('polar', Polar);
