...
define('js/modules/libs/zrender/Storage', 
    ['require', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/shape/Group'],function (require) {

        'use strict';

        var util = require('js/modules/libs/zrender/tool/util');

        var Group = require('js/modules/libs/zrender/shape/Group');
