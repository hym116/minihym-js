 ...
 *
 */
define('js/modules/libs/echarts/chart/base', ['require', 'js/modules/libs/zrender/shape/Image', 'js/modules/libs/echarts/util/shape/Icon', 'js/modules/libs/echarts/util/shape/MarkLine', 'js/modules/libs/echarts/util/shape/Symbol', 'js/modules/libs/echarts/config', 'js/modules/libs/echarts/util/ecData', 'js/modules/libs/echarts/util/ecAnimation', 'js/modules/libs/echarts/util/ecEffect', 'js/modules/libs/echarts/util/accMath', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/area'],function (require) {
    // 图形依赖
    var ImageShape = require('js/modules/libs/zrender/shape/Image');
    var IconShape = require('js/modules/libs/echarts/util/shape/Icon');
    var MarkLineShape = require('js/modules/libs/echarts/util/shape/MarkLine');
    var SymbolShape = require('js/modules/libs/echarts/util/shape/Symbol');
    
    var ecConfig = require('js/modules/libs/echarts/config');
    var ecData = require('js/modules/libs/echarts/util/ecData');
    var ecAnimation = require('js/modules/libs/echarts/util/ecAnimation');
    var ecEffect = require('js/modules/libs/echarts/util/ecEffect');
