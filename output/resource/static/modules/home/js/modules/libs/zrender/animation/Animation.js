 ...
 * @method : stop
 */
define('js/modules/libs/zrender/animation/Animation', 
    ['require', 'js/modules/libs/zrender/animation/Clip', 'js/modules/libs/zrender/tool/color', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/event'],function(require) {
        
        'use strict';

        var Clip = require('js/modules/libs/zrender/animation/Clip');
