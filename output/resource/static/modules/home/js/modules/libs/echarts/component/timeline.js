 ...
 *
 */
define('js/modules/libs/echarts/component/timeline', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/zrender/shape/Rectangle', 'js/modules/libs/echarts/util/shape/Icon', 'js/modules/libs/echarts/util/shape/Chain', 'js/modules/libs/echarts/config', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/area', 'js/modules/libs/zrender/tool/event', 'js/modules/libs/echarts/component'],function (require) {
    ...
    var ChainShape = require('js/modules/libs/echarts/util/shape/Chain');
    ...
    require('js/modules/libs/echarts/component').define('timeline', Timeline);
