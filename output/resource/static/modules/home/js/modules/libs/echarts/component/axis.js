 ...
 *
 */
define('js/modules/libs/echarts/component/axis', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/zrender/shape/Line', 'js/modules/libs/echarts/config', 'js/modules/libs/echarts/util/ecData', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/color', 'js/modules/libs/echarts/component/categoryAxis', 'js/modules/libs/echarts/component/valueAxis', 'js/modules/libs/echarts/component'],function (require) {
    ...
    Axis.prototype = {
        ...
        refresh : function (newOption) {
            ...
            var CategoryAxis = require('js/modules/libs/echarts/component/categoryAxis');
            var ValueAxis = require('js/modules/libs/echarts/component/valueAxis');
    ...
    require('js/modules/libs/echarts/component').define('axis', Axis);
