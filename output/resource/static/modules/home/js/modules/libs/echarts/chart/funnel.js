 ...
 *
 */
define('js/modules/libs/echarts/chart/funnel', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/echarts/chart/base', 'js/modules/libs/zrender/shape/Text', 'js/modules/libs/zrender/shape/Line', 'js/modules/libs/zrender/shape/Polygon', 'js/modules/libs/echarts/config', 'js/modules/libs/echarts/util/ecData', 'js/modules/libs/echarts/util/number', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/color', 'js/modules/libs/zrender/tool/area', 'js/modules/libs/echarts/chart'],function (require) {
    ...
    var number = require('js/modules/libs/echarts/util/number');
    ...
    // 图表注册
    require('js/modules/libs/echarts/chart').define('funnel', Funnel);
