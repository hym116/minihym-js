 ...
 */
define('js/modules/libs/zrender/shape/Sector', 
    ['require', 'js/modules/libs/zrender/tool/math', 'js/modules/libs/zrender/shape/Base', 'js/modules/libs/zrender/shape/Ring', 'js/modules/libs/zrender/shape/Polygon', 'js/modules/libs/zrender/tool/util'],function (require) {
        var math = require('js/modules/libs/zrender/tool/math');
        ...
        Sector.prototype = {
            ...
            getRect : function(style) {
                ...
                if (Math.abs(endAngle - startAngle) >= 360) {
                    // 大于360度的扇形简化为圆环bbox
                    style.__rect = require('js/modules/libs/zrender/shape/Ring').prototype.getRect(style);
                    return style.__rect;
                }
                ...
                style.__rect = require('js/modules/libs/zrender/shape/Polygon').prototype.getRect({
        ...
        require('js/modules/libs/zrender/tool/util').inherits(Sector, Base);
        return Sector;
    }
);