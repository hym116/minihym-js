 ...
 *
 */
define('js/modules/libs/echarts/chart/line', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/echarts/chart/base', 'js/modules/libs/zrender/shape/BrokenLine', 'js/modules/libs/echarts/util/shape/Icon', 'js/modules/libs/echarts/util/shape/HalfSmoothPolygon', 'js/modules/libs/echarts/component/axis', 'js/modules/libs/echarts/component/grid', 'js/modules/libs/echarts/component/dataZoom', 'js/modules/libs/echarts/config', 'js/modules/libs/echarts/util/ecData', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/color', 'js/modules/libs/echarts/chart'],function (require) {
    var ComponentBase = require('js/modules/libs/echarts/component/base');
    var ChartBase = require('js/modules/libs/echarts/chart/base');
    
    // 图形依赖
    var BrokenLineShape = require('js/modules/libs/zrender/shape/BrokenLine');
    var IconShape = require('js/modules/libs/echarts/util/shape/Icon');
    var HalfSmoothPolygonShape = require('js/modules/libs/echarts/util/shape/HalfSmoothPolygon');
    // 组件依赖
    require('js/modules/libs/echarts/component/axis');
    require('js/modules/libs/echarts/component/grid');
    require('js/modules/libs/echarts/component/dataZoom');
    ...
    // 图表注册
    require('js/modules/libs/echarts/chart').define('line', Line);
