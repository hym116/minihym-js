 ...
 *
 */
define('js/modules/libs/echarts/component/tooltip', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/echarts/util/shape/Cross', 'js/modules/libs/zrender/shape/Line', 'js/modules/libs/zrender/shape/Rectangle', 'js/modules/libs/echarts/config', 'js/modules/libs/echarts/util/ecData', 'js/modules/libs/zrender/config', 'js/modules/libs/zrender/tool/event', 'js/modules/libs/zrender/tool/area', 'js/modules/libs/zrender/tool/color', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/shape/Base', 'js/modules/libs/echarts/component'],function (require) {
    var Base = require('js/modules/libs/echarts/component/base');
    
    // 图形依赖
    var CrossShape = require('js/modules/libs/echarts/util/shape/Cross');
    ...
    var zrArea = require('js/modules/libs/zrender/tool/area');
    var zrColor = require('js/modules/libs/zrender/tool/color');
    var zrUtil = require('js/modules/libs/zrender/tool/util');
    var zrShapeBase = require('js/modules/libs/zrender/shape/Base');
    ...
    require('js/modules/libs/echarts/component').define('tooltip', Tooltip);
