 ...
 *
 */
define('js/modules/libs/echarts/util/ecAnimation', ['require', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/shape/Polygon'],function (require) {
    ...
    function polygon(zr, oldShape, newShape, duration, easing) {
        var rect = require('js/modules/libs/zrender/shape/Polygon').prototype.getRect(newShape.style);
