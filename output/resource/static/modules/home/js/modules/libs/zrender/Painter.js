...
define('js/modules/libs/zrender/Painter', 
    ['require', 'js/modules/libs/zrender/config', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/log', 'js/modules/libs/zrender/tool/matrix', 'js/modules/libs/zrender/loadingEffect/Base', 'js/modules/libs/zrender/shape/Image'],function (require) {
        ...
        var BaseLoadingEffect = require('js/modules/libs/zrender/loadingEffect/Base');
