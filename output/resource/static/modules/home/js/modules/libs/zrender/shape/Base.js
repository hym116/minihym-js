 ...
 */
define('js/modules/libs/zrender/shape/Base', 
    ['require', 'js/modules/libs/zrender/tool/matrix', 'js/modules/libs/zrender/tool/guid', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/shape/mixin/Transformable', 'js/modules/libs/zrender/tool/event', 'js/modules/libs/zrender/tool/area', 'js/modules/libs/zrender/tool/color'],function(require) {
        var matrix = require('js/modules/libs/zrender/tool/matrix');
        var guid = require('js/modules/libs/zrender/tool/guid');
        var util = require('js/modules/libs/zrender/tool/util');

        var Transformable = require('js/modules/libs/zrender/shape/mixin/Transformable');
        var Dispatcher = require('js/modules/libs/zrender/tool/event').Dispatcher;
        ...
        function _fillText(ctx, text, x, y, textFont, textAlign, textBaseline) {
            ...
            text = (text + '').split('\n');
            var lineHeight = require('js/modules/libs/zrender/tool/area').getTextHeight('国', textFont);
        ...
        Base.prototype.getHighlightStyle = function (style, highlightStyle, brushTypeOnly) {
            ...
            var color = require('js/modules/libs/zrender/tool/color');
        ...
        Base.prototype.isCover = function (x, y) {
            ...
            if (x >= rect.x
                ...
                // 矩形内
                return require('js/modules/libs/zrender/tool/area').isInside(this, this.style, x, y);
            }
