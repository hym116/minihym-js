 ...
 *
 */
define('js/modules/libs/echarts/component/toolbox', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/zrender/shape/Line', 'js/modules/libs/zrender/shape/Image', 'js/modules/libs/zrender/shape/Rectangle', 'js/modules/libs/echarts/util/shape/Icon', 'js/modules/libs/echarts/config', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/config', 'js/modules/libs/zrender/tool/event', 'js/modules/libs/echarts/component/dataView', 'js/modules/libs/echarts/component'],function (require) {
           ...
           var self = this;
            ...
            for (var i = 0; i < iconLength; i++) {
                ...
                switch(this._iconList[i]) {
                    ...
                    case 'dataView' :
                        if (!this._dataView) {
                            var DataView = require('js/modules/libs/echarts/component/dataView');
    ...
    require('js/modules/libs/echarts/component').define('toolbox', Toolbox);
