 ...
 *
 */
define('js/modules/libs/echarts/chart/gauge', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/echarts/chart/base', 'js/modules/libs/echarts/util/shape/GaugePointer', 'js/modules/libs/zrender/shape/Text', 'js/modules/libs/zrender/shape/Line', 'js/modules/libs/zrender/shape/Rectangle', 'js/modules/libs/zrender/shape/Circle', 'js/modules/libs/zrender/shape/Sector', 'js/modules/libs/echarts/config', 'js/modules/libs/echarts/util/ecData', 'js/modules/libs/echarts/util/accMath', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/echarts/chart'],function (require) {
    var ComponentBase = require('js/modules/libs/echarts/component/base');
    var ChartBase = require('js/modules/libs/echarts/chart/base');
    
    // 图形依赖
    var GaugePointerShape = require('js/modules/libs/echarts/util/shape/GaugePointer');
    ...
    var SectorShape = require('js/modules/libs/zrender/shape/Sector');

    var ecConfig = require('js/modules/libs/echarts/config');
    var ecData = require('js/modules/libs/echarts/util/ecData');
    var accMath = require('js/modules/libs/echarts/util/accMath');
    ...
    // 图表注册
    require('js/modules/libs/echarts/chart').define('gauge', Gauge);
