...
define('js/modules/libs/zrender/loadingEffect/Whirling', 
    ['require', 'js/modules/libs/zrender/loadingEffect/Base', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/shape/Ring', 'js/modules/libs/zrender/shape/Droplet', 'js/modules/libs/zrender/shape/Circle'],function (require) {
        var Base = require('js/modules/libs/zrender/loadingEffect/Base');
