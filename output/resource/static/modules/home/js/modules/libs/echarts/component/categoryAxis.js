 ...
 *
 */
define('js/modules/libs/echarts/component/categoryAxis', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/zrender/shape/Text', 'js/modules/libs/zrender/shape/Line', 'js/modules/libs/zrender/shape/Rectangle', 'js/modules/libs/echarts/config', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/area', 'js/modules/libs/echarts/component'],function (require) {
    ...
    require('js/modules/libs/echarts/component').define('categoryAxis', CategoryAxis);
