...
define('js/modules/libs/echarts/chart/bar', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/echarts/chart/base', 'js/modules/libs/zrender/shape/Rectangle', 'js/modules/libs/echarts/component/axis', 'js/modules/libs/echarts/component/grid', 'js/modules/libs/echarts/component/dataZoom', 'js/modules/libs/echarts/config', 'js/modules/libs/echarts/util/ecData', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/color', 'js/modules/libs/echarts/chart'],function (require) {
    ...
    // 图表注册
    require('js/modules/libs/echarts/chart').define('bar', Bar);
