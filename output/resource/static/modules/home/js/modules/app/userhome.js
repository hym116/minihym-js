define('js/modules/app/userhome', ['require', 'exports', 'module', "jquery", "js/modules/pkgs/product-list", "js/modules/apis/api-aio", "js/modules/libs/ui/popup/popup", "js/modules/pkgs/follow", "js/modules/pkgs/ajax-form/ajax-form"],function(require, exports, module) {
var $ = require("jquery");
        ...
        Boxy.confirm("<div>确定要删除此产品？</div>",function(){
            ...
            .done(function(data) {
                if (data.code === 0) {
                    parent.remove();
                    if (data.data >= 0) {
                        $(".user_infos .prodnum b").text(parseInt(data.data));
                    }
