 ...
 *
 */
define('js/modules/libs/echarts/chart/map', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/echarts/chart/base', 'js/modules/libs/zrender/shape/Text', 'js/modules/libs/zrender/shape/Path', 'js/modules/libs/zrender/shape/Circle', 'js/modules/libs/zrender/shape/Rectangle', 'js/modules/libs/zrender/shape/Line', 'js/modules/libs/zrender/shape/Polygon', 'js/modules/libs/zrender/shape/Ellipse', 'js/modules/libs/echarts/component/dataRange', 'js/modules/libs/echarts/config', 'js/modules/libs/echarts/util/ecData', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/config', 'js/modules/libs/zrender/tool/event', 'js/modules/libs/echarts/util/mapData/params', 'js/modules/libs/echarts/util/mapData/textFixed', 'js/modules/libs/echarts/util/mapData/geoCoord', 'js/modules/libs/echarts/util/projection/svg', 'js/modules/libs/echarts/util/projection/normal', 'js/modules/libs/echarts/chart'],function (require) {
    var ComponentBase = require('js/modules/libs/echarts/component/base');
    var ChartBase = require('js/modules/libs/echarts/chart/base');
    
    // 图形依赖
    var TextShape = require('js/modules/libs/zrender/shape/Text');
    var PathShape = require('js/modules/libs/zrender/shape/Path');
    var CircleShape = require('js/modules/libs/zrender/shape/Circle');
    var RectangleShape = require('js/modules/libs/zrender/shape/Rectangle');
    var LineShape = require('js/modules/libs/zrender/shape/Line');
    var PolygonShape = require('js/modules/libs/zrender/shape/Polygon');
    var EllipseShape = require('js/modules/libs/zrender/shape/Ellipse');
    // 组件依赖
    require('js/modules/libs/echarts/component/dataRange');
    ...
    var zrConfig = require('js/modules/libs/zrender/config');
    var zrEvent = require('js/modules/libs/zrender/tool/event');
    
    var _mapParams = require('js/modules/libs/echarts/util/mapData/params').params;
    var _textFixed = require('js/modules/libs/echarts/util/mapData/textFixed');
    var _geoCoord = require('js/modules/libs/echarts/util/mapData/geoCoord');
    ...
    Map.prototype = {
        ...
        _mapDataCallback : function (mt, vd, ms) {
            ...
            return function (md) {
                ...
                if (md.firstChild) {
                    ...
                    self._mapDataMap[mt].projection = require('js/modules/libs/echarts/util/projection/svg');
                }
                else {
                    self._mapDataMap[mt].rate = 0.75;
                    self._mapDataMap[mt].projection = require('js/modules/libs/echarts/util/projection/normal');
                }
        ...
        _getSpecialProjectionData : function (mapType, mapData, areaName, mapSize, position) {
            ...
            // bbox
            var normalProjection = require('js/modules/libs/echarts/util/projection/normal');
    ...
    // 图表注册
    require('js/modules/libs/echarts/chart').define('map', Map);
