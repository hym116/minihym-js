 ...
 *
 */
define('js/modules/libs/echarts/component/grid', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/zrender/shape/Rectangle', 'js/modules/libs/echarts/config', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/echarts/component'],function (require) {
    ...
    require('js/modules/libs/echarts/component').define('grid', Grid);
