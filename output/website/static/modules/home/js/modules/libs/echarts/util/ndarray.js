 ...
 */
define('js/modules/libs/echarts/util/ndarray', ['require', 'js/modules/libs/echarts/util/kwargs'],function (require) {

'use strict';

var kwargs = require('js/modules/libs/echarts/util/kwargs');
