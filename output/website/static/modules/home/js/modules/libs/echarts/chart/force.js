...
define('js/modules/libs/echarts/chart/force', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/echarts/chart/base', 'js/modules/libs/echarts/chart/forceLayoutWorker', 'js/modules/libs/zrender/shape/Line', 'js/modules/libs/echarts/util/shape/Icon', 'js/modules/libs/echarts/config', 'js/modules/libs/echarts/util/ecData', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/config', 'js/modules/libs/zrender/tool/vector', 'js/modules/libs/echarts/util/ndarray', 'js/modules/libs/echarts/chart'],function (require) {
    'use strict';
    
    var ComponentBase = require('js/modules/libs/echarts/component/base');
    var ChartBase = require('js/modules/libs/echarts/chart/base');

    var ForceLayout = require('js/modules/libs/echarts/chart/forceLayoutWorker');
    ...
    var vec2 = require('js/modules/libs/zrender/tool/vector');

    var NDArray = require('js/modules/libs/echarts/util/ndarray');
    ...
    // 图表注册
    require('js/modules/libs/echarts/chart').define('force', Force);
