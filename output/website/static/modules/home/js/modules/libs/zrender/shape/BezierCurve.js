 ...
 */
define('js/modules/libs/zrender/shape/BezierCurve', 
    ['require', 'js/modules/libs/zrender/shape/Base', 'js/modules/libs/zrender/tool/util'],function (require) {
        ...
        require('js/modules/libs/zrender/tool/util').inherits(BezierCurve, Base);
        return BezierCurve;
    }
);