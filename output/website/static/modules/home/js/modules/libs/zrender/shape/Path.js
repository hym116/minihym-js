...
define('js/modules/libs/zrender/shape/Path', ['require', 'js/modules/libs/zrender/shape/Base', 'js/modules/libs/zrender/tool/util'],function (require) {
    ...
    require('js/modules/libs/zrender/tool/util').inherits(Path, Base);
    return Path;
});