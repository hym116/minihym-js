 ...
 *
 */
define('js/modules/libs/echarts/echarts', ['require', 'js/modules/libs/echarts/config', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/event', 'js/modules/libs/zrender/tool/env', 'js/modules/libs/zrender/zrender', 'js/modules/libs/zrender/config', 'js/modules/libs/echarts/chart/island', 'js/modules/libs/echarts/component/toolbox', 'js/modules/libs/echarts/component', 'js/modules/libs/echarts/component/title', 'js/modules/libs/echarts/component/tooltip', 'js/modules/libs/echarts/component/legend', 'js/modules/libs/echarts/util/ecData', 'js/modules/libs/echarts/chart', 'js/modules/libs/zrender/tool/color', 'js/modules/libs/echarts/component/timeline', 'js/modules/libs/zrender/shape/Image', 'js/modules/libs/zrender/loadingEffect/Bar', 'js/modules/libs/zrender/loadingEffect/Bubble', 'js/modules/libs/zrender/loadingEffect/DynamicLine', 'js/modules/libs/zrender/loadingEffect/Ring', 'js/modules/libs/zrender/loadingEffect/Spin', 'js/modules/libs/zrender/loadingEffect/Whirling', 'js/modules/libs/echarts/theme/default'],function (require) {
    var ecConfig = require('js/modules/libs/echarts/config');
    var zrUtil = require('js/modules/libs/zrender/tool/util');
    var zrEvent = require('js/modules/libs/zrender/tool/event');
    
    var self = {};
    
    var _canvasSupported = require('js/modules/libs/zrender/tool/env').canvasSupported;
    ...
    self.init = function (dom, theme) {
        var zrender = require('js/modules/libs/zrender/zrender');
     ...
     * @type {Object}
     */
    var ZR_EVENT = require('js/modules/libs/zrender/config').EVENT;
    ...
    Echarts.prototype = {
        ...
        _init : function () {
            var self = this;
            var _zr = require('js/modules/libs/zrender/zrender').init(this.dom);
            this._zr = _zr;
            ...
            // 内置图表
            // 孤岛
            var Island = require('js/modules/libs/echarts/chart/island');
            this._island = new Island(this._themeConfig, this._messageCenter, _zr, {}, this);
            this.chart.island = this._island;
            
            // 内置通用组件
            // 工具箱
            var Toolbox = require('js/modules/libs/echarts/component/toolbox');
            this._toolbox = new Toolbox(this._themeConfig, this._messageCenter, _zr, {}, this);
            this.component.toolbox = this._toolbox;
            
            var componentLibrary = require('js/modules/libs/echarts/component');
            componentLibrary.define('title', require('js/modules/libs/echarts/component/title'));
            componentLibrary.define('tooltip', require('js/modules/libs/echarts/component/tooltip'));
            componentLibrary.define('legend', require('js/modules/libs/echarts/component/legend'));
        },
        ...
        _eventPackage : function (target) {
            if (target) {
                var ecData = require('js/modules/libs/echarts/util/ecData');
        ...
        _render : function (magicOption) {
            ...
            var chartLibrary = require('js/modules/libs/echarts/chart');
            var componentLibrary = require('js/modules/libs/echarts/component');
        ...
        _mergeGlobalConifg : function (magicOption) {
            ...
            this._zr.getColor = function (idx) {
                var zrColor = require('js/modules/libs/zrender/tool/color');
        ...
        _setTimelineOption : function(option) {
            ...
            var Timeline = require('js/modules/libs/echarts/component/timeline');
        ...
        getConnectedDataURL : function (imgType) {
            ...
            var zrImg = require('js/modules/libs/zrender/zrender').init(zrDom);
            
            var ImageShape = require('js/modules/libs/zrender/shape/Image');
        ...
        showLoading : function (loadingOption) {
            var effectList = {
                bar : require('js/modules/libs/zrender/loadingEffect/Bar'),
                bubble : require('js/modules/libs/zrender/loadingEffect/Bubble'),
                dynamicLine : require('js/modules/libs/zrender/loadingEffect/DynamicLine'),
                ring : require('js/modules/libs/zrender/loadingEffect/Ring'),
                spin : require('js/modules/libs/zrender/loadingEffect/Spin'),
                whirling : require('js/modules/libs/zrender/loadingEffect/Whirling')
            };
            ...
            if (theme) {
               if (typeof theme === 'string') {
                    ...
                    switch (theme) {
                        ...
                        default:
                            theme = require('js/modules/libs/echarts/theme/default');
                    }
                }
                else {
                    theme = theme || {};
