 ...
 *
 */
define('js/modules/libs/echarts/component/base', ['require', 'js/modules/libs/echarts/config', 'js/modules/libs/echarts/util/ecQuery', 'js/modules/libs/echarts/util/number', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/env'],function (require) {
    var ecConfig = require('js/modules/libs/echarts/config');
    var ecQuery = require('js/modules/libs/echarts/util/ecQuery');
     ...
     */
    Base.prototype = {
        canvasSupported : require('js/modules/libs/zrender/tool/env').canvasSupported,
        /**
         * 获取zlevel基数配置
