 ...
 */
define('js/modules/libs/echarts/util/shape/Icon', ['require', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/shape/Star', 'js/modules/libs/zrender/shape/Heart', 'js/modules/libs/zrender/shape/Droplet', 'js/modules/libs/zrender/shape/Image', 'js/modules/libs/zrender/shape/Base'],function (require) {
    ...
    function _iconStar(ctx, style) {
        var StarShape = require('js/modules/libs/zrender/shape/Star');
        var width = style.width / 2;
        var height = style.height / 2;
    ...
    function _iconHeart(ctx, style) {
        var HeartShape = require('js/modules/libs/zrender/shape/Heart');
    ...
    function _iconDroplet(ctx, style) {
        var DropletShape = require('js/modules/libs/zrender/shape/Droplet');
