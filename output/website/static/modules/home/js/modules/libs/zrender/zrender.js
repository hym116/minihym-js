 ...
 *
 */
define('js/modules/libs/zrender/zrender', 
    ['require', 'js/modules/libs/zrender/lib/excanvas', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/log', 'js/modules/libs/zrender/tool/guid', 'js/modules/libs/zrender/Handler', 'js/modules/libs/zrender/Painter', 'js/modules/libs/zrender/Storage', 'js/modules/libs/zrender/animation/Animation', 'js/modules/libs/zrender/tool/env'],function(require) {
        /*
        ...
        require('js/modules/libs/zrender/lib/excanvas');

        var util = require('js/modules/libs/zrender/tool/util');
        var log = require('js/modules/libs/zrender/tool/log');
        var guid = require('js/modules/libs/zrender/tool/guid');

        var Handler = require('js/modules/libs/zrender/Handler');
        var Painter = require('js/modules/libs/zrender/Painter');
        var Storage = require('js/modules/libs/zrender/Storage');
        var Animation = require('js/modules/libs/zrender/animation/Animation');
        ...
        function ZRender(id, dom) {
            this.id = id;
            this.env = require('js/modules/libs/zrender/tool/env');
