 ...
 *
 */
define('js/modules/libs/echarts/component/dataRange', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/zrender/shape/Text', 'js/modules/libs/zrender/shape/Rectangle', 'js/modules/libs/echarts/util/shape/HandlePolygon', 'js/modules/libs/echarts/config', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/area', 'js/modules/libs/zrender/tool/color', 'js/modules/libs/echarts/component'],function (require) {
    ...
    var HandlePolygonShape = require('js/modules/libs/echarts/util/shape/HandlePolygon');
    ...
    require('js/modules/libs/echarts/component').define('dataRange', DataRange);
