...
define('js/modules/libs/zrender/Handler', 
    ['require', 'js/modules/libs/zrender/config', 'js/modules/libs/zrender/tool/env', 'js/modules/libs/zrender/tool/event', 'js/modules/libs/zrender/tool/util'],function (require) {

        'use strict';

        var config = require('js/modules/libs/zrender/config');
        var env = require('js/modules/libs/zrender/tool/env');
        var eventTool = require('js/modules/libs/zrender/tool/event');
