...
define('js/modules/libs/echarts/chart/forceLayoutWorker', ['require', 'js/modules/libs/zrender/tool/vector'],function __echartsForceLayoutWorker(require) {
    ...
    if (inWorker) {
        ...
        vec2 = require('js/modules/libs/zrender/tool/vector');
    }
