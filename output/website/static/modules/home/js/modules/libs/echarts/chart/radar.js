 ...
 */
 ...
 define('js/modules/libs/echarts/chart/radar', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/echarts/chart/base', 'js/modules/libs/zrender/shape/Polygon', 'js/modules/libs/echarts/component/polar', 'js/modules/libs/echarts/config', 'js/modules/libs/echarts/util/ecData', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/color', 'js/modules/libs/echarts/util/accMath', 'js/modules/libs/echarts/chart'],function (require) {
    ...
    var PolygonShape = require('js/modules/libs/zrender/shape/Polygon');
     // 组件依赖
    require('js/modules/libs/echarts/component/polar');
    ...
    // 图表注册
    require('js/modules/libs/echarts/chart').define('radar', Radar);
