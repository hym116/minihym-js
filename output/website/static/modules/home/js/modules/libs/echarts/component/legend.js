 ...
 *
 */
define('js/modules/libs/echarts/component/legend', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/zrender/shape/Text', 'js/modules/libs/zrender/shape/Rectangle', 'js/modules/libs/zrender/shape/Sector', 'js/modules/libs/echarts/util/shape/Icon', 'js/modules/libs/echarts/util/shape/Candle', 'js/modules/libs/echarts/config', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/area', 'js/modules/libs/echarts/component'],function (require) {
    ...
    var CandleShape = require('js/modules/libs/echarts/util/shape/Candle');
    ...
    require('js/modules/libs/echarts/component').define('legend', Legend);
