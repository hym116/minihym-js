 ...
 *
 */
define('js/modules/libs/echarts/chart/pie', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/echarts/chart/base', 'js/modules/libs/zrender/shape/Text', 'js/modules/libs/zrender/shape/Ring', 'js/modules/libs/zrender/shape/Circle', 'js/modules/libs/zrender/shape/Sector', 'js/modules/libs/zrender/shape/BrokenLine', 'js/modules/libs/echarts/config', 'js/modules/libs/echarts/util/ecData', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/math', 'js/modules/libs/zrender/tool/color', 'js/modules/libs/echarts/chart'],function (require) {
    ...
    var RingShape = require('js/modules/libs/zrender/shape/Ring');
    ...
    var zrMath = require('js/modules/libs/zrender/tool/math');
    ...
    // 图表注册
    require('js/modules/libs/echarts/chart').define('pie', Pie);
