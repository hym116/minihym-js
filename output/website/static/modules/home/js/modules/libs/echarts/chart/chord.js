...
define('js/modules/libs/echarts/chart/chord', ['require', 'js/modules/libs/echarts/component/base', 'js/modules/libs/echarts/chart/base', 'js/modules/libs/zrender/shape/Text', 'js/modules/libs/zrender/shape/Line', 'js/modules/libs/zrender/shape/Sector', 'js/modules/libs/echarts/util/shape/Chord', 'js/modules/libs/echarts/config', 'js/modules/libs/echarts/util/ecData', 'js/modules/libs/zrender/tool/util', 'js/modules/libs/zrender/tool/vector', 'js/modules/libs/echarts/util/ndarray', 'js/modules/libs/echarts/chart'],function (require) {
    'use strict';
    ...
    var ChordShape = require('js/modules/libs/echarts/util/shape/Chord');
    ...
    // 图表注册
    require('js/modules/libs/echarts/chart').define('chord', Chord);
