define('js/modules/app/uc-prodadd-step1', ['require', 'exports', 'module', "jquery", "js/modules/apis/api-aio", "js/modules/libs/ui/popup/popup", "js/modules/pkgs/ajax-form/ajax-form", "js/modules/libs/ui/dropkick/dropkick"],function(require, exports, module) {
var $ = require("jquery");
...
$(function() {
    ...
    $(".single-check .item-wrap .js-back").click(function() {
        var parent = $(this).closest('.formitem');
