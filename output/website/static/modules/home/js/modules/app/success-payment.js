define('js/modules/app/success-payment', ['require', 'exports', 'module', "js/modules/libs/ui/icheck/icheck"],function(require, exports, module) {
    ...
    $(".label-outer input[type = 'radio']").on("ifChanged",function(){
        ...
        if(that.prop("checked")){
            ...
            if(that.val() == 1){
                ...
                that.parents(".select").find(".triangle-box").css("left","100px");
                ...
                that.parents(".select").find(".triangle-box").css("left","293px");
