...
! function() {
    ...
    e.prototype.init = function() {
        ...
        e = r(), this.swiper = this.$power.swiper(e), "horizontal" === e.mode ? this.swiper.addCallback("SlideChangeStart", function() {
            ...
            //t.swiper.swipeNext()
        }), this.$arrow.html("horizontal" === e.mode ? '<img src="img/arrow-left.png" alt="滑动提示">' : '<img src="'+static_mpath+'/img/arrow-up.png" alt="滑动提示"></a>'), this.$arrow.addClass("horizontal" === e.mode ? "ui-left-arrow" : "ui-up-arrow ")
